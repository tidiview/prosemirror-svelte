...
<sup>4</sup>
and others of them, from a natural instability and fickleness of disposition, were anxious for a revolution; [the Belgae were instigated] by several, also, because the government in Gaul was generally seized upon by the more powerful persons and by those who had the means of hiring troops, and they could less easily effect this object under our dominion. </p>
<h4 id="2chap" class="green">Measures of Caesar</h4>
<p><span style="color: #3d8b3d;">Chapter 2</span>
<sup>1</sup>
Alarmed by these tidings and letters, <span style="color: #3d8b3d;">Caesar</span> levied two new legions in Hither Gaul, and, at the beginning of summer, sent Quintus Pedius, his legate, to conduct them further into Gaul.
<sup>2</sup>
...
<sup>5</sup>
Then, indeed, he thought that he ought not to hesitate about proceeding toward them, and having provided supplies, moves his camp, and in about fifteen days arrives at the territories of the Belgae. </p>
<h4 id="3chap" class="green">The Remi are declaring themselves for the Romans</h4>
<p><span style="color: #3d8b3d;">Chapter 3</span>
<sup>1</sup>
As he arrived there unexpectedly and sooner than any one anticipated, <span style="color: #3d8b3d;">the Remi</span>, who are the nearest of the Belgae to [Celtic] Gaul, sent to him Iccius and Andecombogius, [two of] the principal persons of the state, as their embassadors:
<sup>2</sup>
...
<sup>10</sup>
that the Condrusi, the Eburones, the Caeraesi, the Paemani, who are called by the common name of Germans [had promised], they thought, to the number of 40,000. </p>
<h4 id="diviciacus-attacks-the-bellovaci-caesar-crosses-the-aisne" class="green">Diviciacus attacks the Bellovaci. Caesar crosses the Aisne</h4>
<p><span style="color: #3d8b3d;">Chapter 5</span>
<sup>1</sup>
<span style="color: #3d8b3d;">Caesar</span>, having encouraged <span style="color: #3d8b3d;">the Remi</span>, and addressed them courteously, ordered the whole senate to assemble before him, and the children of their chief men to be brought to him as hostages; all which commands they punctually performed by the day [appointed].
<sup>2</sup>
...
<sup>4</sup>
After he perceived that all the forces of the Belgae, which had been collected in one place, were approaching toward him, and learned from the scouts whom he had sent out, and [also] from <span style="color: #3d8b3d;">the Remi</span>, that they were then not far distant, he hastened to lead his army over the Aisne, which is on the borders of <span style="color: #3d8b3d;">the Remi</span>, and there pitched his camp.
<sup>5</sup>
This position fortified one side of his camp by the banks of the river, rendered the country which lay in his rear secure from the enemy, and furthermore insured that provisions might without danger be brought to him by <span style="color: #3d8b3d;">the Remi</span> and the rest of the states.
<sup>6</sup>
Over that river was a bridge: there he places a guard; and on the other side of the river he leaves Quintus Titurius Sabinus, his legate, with six cohorts. He orders him to fortify a camp with a rampart twelve feet in height, and a trench eighteen feet in breadth. </p>
<h4 id="he-raised-the-siege-of-bibrax" class="green">He raised the siege of Bibrax</h4>
<p><span style="color: #3d8b3d;">Chapter 6</span>
<sup>1</sup>
There was a town of <span style="color: #3d8b3d;">the Remi</span>, by name Bibrax, eight miles distant from this camp. This the Belgae on their march began to attack with great vigor. [The assault] was with difficulty sustained for that day.
<sup>2</sup>
...
<sup>4</sup>
When night had put an end to the assault, Iccius Remus, who was then in command of the town, one of <span style="color: #3d8b3d;">the Remi</span>, a man of the highest rank and influence among his people, and one of those who had come to <span style="color: #3d8b3d;">Caesar</span> as embassador [to sue] for peace, sends messengers to him, [to report] "That, unless assistance were sent to him he could not hold out any longer." </p>
<p><span style="color: #3d8b3d;">Chapter 7</span>
<sup>1</sup>
Thither, immediately after midnight, <span style="color: #3d8b3d;">Caesar</span>, using as guides the same persons who had come to him as messengers from Iccius, sends some Numidian and Cretan archers, and some Balearian slingers
<sup>2</sup>
as a relief to the towns-people, by whose arrival both a desire to resist together with the hope of [making good their] defense, was infused into <span style="color: #3d8b3d;">the Remi</span>, and, for the same reason, the hope of gaining the town, abandoned the enemy.
<sup>3</sup>
Therefore, after staying a short time before the town, and laying waste the country of <span style="color: #3d8b3d;">the Remi</span>, when all the villages and buildings which they could approach had been burned, they hastened with all their forces to the camp of <span style="color: #3d8b3d;">Caesar</span>, and encamped within less than two miles [of it];
<sup>4</sup>
and their camp, as was indicated by the smoke and fires, extended more than eight miles in breadth. </p>
<h4 id="8chap" class="green">Battle of the Aisne</h4>
<p><span style="color: #3d8b3d;">Chapter 8</span>
<sup>1</sup>
<span style="color: #3d8b3d;">Caesar</span> at first determined to decline a battle, as well on account of the great number of the enemy as their distinguished reputation for valor:
<sup>2</sup>
...
<p><span style="color: #3d8b3d;">Chapter 9</span>
<sup>1</sup>
...
<sup>2</sup>
In the mean time battle was commenced between the two armies by a cavalry action. When neither army began to pass the marsh, <span style="color: #3d8b3d;">Caesar</span>, upon the skirmishes of the horse [proving] favorable to our men, led back his forces into the camp.
<sup>3</sup>
The enemy immediately hastened from that place to the river Aisne, which it has been stated, was behind our camp.
<sup>4</sup>
Finding a ford there, they endeavored to lead a part of their forces over it; with the design, that, if they could, they might carry by storm the fort which Quintus Titurius, <span style="color: #3d8b3d;">Caesar</span>'s legate, commanded, and might cut off the bridge;
<sup>5</sup>
but, if they could not do that, they should lay waste the lands of <span style="color: #3d8b3d;">the Remi</span>, which were of great use to us in carrying on the war, and might hinder our men from foraging. </p>
<p><span style="color: #3d8b3d;">Chapter 10</span>
<sup>1</sup>
<span style="color: #3d8b3d;">Caesar</span>, being apprized of this by Titurius, leads all his cavalry and light-armed Numidians, slingers and archers, over the bridge, and hastens toward them.
<sup>2</sup>
...
<p><span style="color: #3d8b3d;">Chapter 11</span>
<sup>1</sup>
...
<sup>2</sup>
<span style="color: #3d8b3d;">Caesar</span>, immediately learning this through his scouts, [but] fearing an ambuscade, because he had not yet discovered for what reason they were departing, kept his army and cavalry within the camp.
<sup>3</sup>
...
<sup>6</sup>
Thus without any risk [to themselves] our men killed as great a number of them as the length of the day allowed; and at sunset desisted from the pursuit, and betook themselves into the camp, as they had been commanded. </p>
<p><span style="color: #3d8b3d;">Chapter 12</span>
<sup>1</sup>
On the day following, before the enemy could recover from their terror and flight, <span style="color: #3d8b3d;">Caesar</span> led his army into the territories of the Suessiones, which are next to <span style="color: #3d8b3d;">the Remi</span>, and having accomplished a long march, hastens to the town named Noviodunum.
<sup>2</sup>
