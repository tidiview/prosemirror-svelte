...
<p><audio controls="1" title="prononciation du prénom « François »" alt="" id="audio0"><source src="https://francois-vidit.com/user/sites/profile/pages/01.home/02.nom/Francois.mp3" type="audio/mpeg">Votre navigateur ne prend pas en charge la balise audio.</audio></p>

<p><span title="Nom">VIDIT</span>, ici le nom, se prononce: <span title="prononciation du nom de famille « VIDIT »">[vidi]</span></p>

<p><audio controls="1" title="prononciation du nom de famille « VIDIT »" alt="" id="audio1"><source src="https://francois-vidit.com/user/sites/profile/pages/01.home/02.nom/VIDIT.mp3" type="audio/mpeg">Votre navigateur ne prend pas en charge la balise audio.</audio></p>

<p><span style="color:#000e5f">François VIDIT est </span> <span title="Profession" style="color:#000e5f">guide-interprète japonais</span><span style="color:#000e5f"> à </span><span style="color:#000e5f">Paris</span><span style="color:#000e5f">. Depuis plus de <time datetime="P20Y">20 ans</time>, il exerce sous diverses formes, du guidage touristique, conseil interculturel, interprétariat consécutif, à la traduction.</span></p>
...
<p>Il intègre une <a href="http://www.garde-intl.com/" title="http://www.garde-intl.com/">entreprise</a> de conception et de réalisation de réseaux commerciaux de marques de luxe dans les plus grandes villes japonaises dans le prestigieux quartier d'<a href="https://www.google.fr/maps/place/Minamiaoyama, Minato-ku, Tokyo 107-0062, Japon/@35.6645978,139.7148829,15.75z/data=!4m5!3m4!1s0x60188b6254cc464f:0x99773132a4b583e6!8m2!3d35.6653189!4d139.7149995" title="https://www.google.fr/maps/place/Minamiaoyama">Aoyama</a> à <a href="#fn:1">Tōkiō</a>.</p>
<p>De retour en France, il change de profession et devient interprète.</p>

<aside>
  <p id="fn:1"><i>Tōkiō</i>: cette orthographe est rare, mais c'est la transgraphie française régulière; elle date de la fin du dix-neuvième siècle; elle a encore cours officiellement, par exemple dans certains actes officiels dont on souhaite marquer le caractère solennel; à la différence de la transgraphie anglaise actuelle, elle reflète fidèlement la prononciation originale en indiquant les nuances de prononciation par accentuation; transgraphie anglaise: Tokyo.</p>
  <footer>
...
<p><span style="min-width: 260px;;float: left;"><abbr title="numéro">n°</abbr> d'imma<wbr>tri<wbr>cu<wbr>lation profes<wbr>sion<wbr>nelle: </span><wbr><samp>GC1375538P</samp></p>
