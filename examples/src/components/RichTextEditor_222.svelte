<script>
  ...
  const html = `<!-- Page 20 EN:212 JA:217 -->
...
<hr>
      ...
      <hr>
        ...
        <footer>
          <ul>
            <li><p><p><a href="https://francois-vidit.com/docs/fr/bruges/hopital-saint-jean/saint-jean/page:13#renvoi-apocalypse-10-4">Retour au texte associé ↩</a></p></li>
