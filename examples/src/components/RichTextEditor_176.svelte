...
<article>
  ...
  <figure>
    ...
    https://francois-vidit.com/user/sites/docs/pages/01.home/06.bruges/01.hopital-saint-jean/01.saint-jean/02.saint-jean_2/saint-jean_0-1920.jpg 1920w"></picture><figcaption>le triptyque ouvert</figcaption>
  </figure>
  ...
  <article>
    ...
    <section><article>
      ...
      <p>Ce triptyque a été conçu et réalisé pour le maître-autel de la nouvelle abside de l'église de l'ancien hôpital Saint-Jean de Bruges construite en <time datetime="1473">1473</time>-74, où il se trouve toujours.</p>
    ...
    <section><article>
      <h3 id="presentation-de-l-œuvre" class="yellow">présentation de l'œuvre</h3>
      <p>Dans les pages qui suivent, nous présentons les différents aspects cette œuvre afin d'en permettre une compréhension approfondie:</p>
      <ol>
        ...
        <li>puis par une <a href="/docs/fr/bruges/hopital-saint-jean/saint-jean/page:2#description" title="https://francois-vidit.com/docs/fr/bruges/hopital-saint-jean/saint-jean/page:2#description" class="yellow">description détaillée de ce qu'elle représente</a>,</li>
        <li>enfin par la <a href="/docs/fr/bruges/hopital-saint-jean/sint-jean/page:16#mise-en-relation" title="https://francois-vidit.com/docs/fr/bruges/hopital-saint-jean/saint-jean/page:16#mise-en-relation" id="renvoi-mise-en-relation" class="yellow">mise en relation des différents éléments de l'image avec les différents textes</a> sur lesquels il est raisonnable de penser que le peintre lui-même s'est fondé afin de concevoir sa représentation des sujets religieux. </li>
      </ol>
    </article></section>
  </article>
...
<aside>
  <section><article>
    <h3 id="a-propos-de-cet-article" class="yellow">à propos de cet article</h3>
    ...
    <p>Notre but n'est toutefois pas de produire ici une  interprétation de l'œuvre mais plutôt <span style="color: #e6a64d;">une desciption</span> et à travers elle de mettre à disposition les éléments qui permettent de s'en saisir: <span style="color: #e6a64d;">des reproductions de qualité</span> <a href="#note-1" title="note-1" id="renvoi-note-1"><sup style="color:#555;">note 1</sup></a> , <span style="color: #e6a64d;">les principales sources de l'œuvre</span>, quelles soient textuelles ou picturales, ce qui aujourd'hui, même dans le cas d'ouvrages papier spécialisés disponibles par exemple dans des bibliothèques, ne se fait trop souvent que par renvoi ou sous-entendu.</p>
  ...
  <section><article>
    ...
    <article>
      ...
      <p>les reproductions de l'œuvre que nous mettons à disposition du public sont à notre connaissance les meilleures actuellement existantes en dehors d'ouvrages professionnels: elles nous ont demandé un énorme travail du fait de la faiblesse de l'intensité et du jaune de l'éclairage actuel.</p>
      ...
      <ul>
        ...
        <li><a href="/docs/fr/bruges/hopital-saint-jean/saint-jean/page:6#legendes" title="https//francois-vidit.com/docs/fr/bruges/hopital-saint-jean/saint-jean/page:6#legendes" class="yellow">légendes de jean le baptiste et jean l'évangéliste</a>
          <ul>
            ...
            <li><a href="/docs/fr/bruges/hopital-saint-jean/saint-jean/page:10#legede-de-jean-l-evangeliste" title="https://francois-vidit.com/docs/fr/bruges/hopital-saint-jean/saint-jean/page:10#legende-de-jean-l-evangeliste" class="yellow">légende de jean l’évangéliste</a></li>
          </ul></li>
...
<article>
  <section><article>
    ...
    <section><article>
      ...
      <figure>
        ...
        https://francois-vidit.com/user/sites/docs/pages/01.home/06.bruges/01.hopital-saint-jean/01.saint-jean/04.saint-jean_4/sainte-conversation-1920.jpg 1920w"></picture><figcaption>vue du panneau central, une conversation sacrée</figcaption>
      </figure>
    </article></section>
    <section><article>
    ...
    <section><article>
      <p>La symétrie et à la simplicité des positions les unes par rapport aux autres dans la largeur s'accorde à la forme du tryptique.</p>
      <p>La hauteur et la profondeur s'organisent autour de la <span style="color: #e6a64d;">distinction hommes femmes</span>: sur le <span style="color: #e6a64d;">devant</span> en bas, <span style="color: #e6a64d;">deux femmes</span>, sur le <span style="color: #e6a64d;">derrière</span> en haut, <span style="color: #e6a64d;">deux hommes</span>.</p>
      ...
      <p>Les personnages représentés semblent de <span style="color: #e6a64d;">la même famille</span> et sont <span style="color: #e6a64d;">de tous âges</span>:
  ...
  <section><article>
    <h3 id="devotion-moderne" class="yellow">une expression remarquable de la “dévotion moderne”</h3>
    <section><article>
    ...
    <section><article>
      ...
      <div class="notices yellow">
        <blockquote class="yellow">
          <p>L'être humain s'élève au-dessus de la terre sur deux ailes, la <span style="color: #b37319;">simplicité</span> et la <span style="color: #b37319;">pureté</span>.</p>
          <p>La simplicité doit être dans l'<span style="color: #b37319;">intention</span>, et la pureté dans l'<span style="color: #b37319;">affection</span>.</p>
          <p>La simplicité <span style="color: #9c6416;">cherche</span> dieu, la pureté le <span style="color: #9c6416;">trouve</span> et le <span style="color: #9c6416;">goûte</span>.</p>
          <p>Nulle bonne œuvre ne vous sera difficile, si vous êtes libre au-dedans de toute affection déréglée.</p>
          <p>Si vous ne voulez que ce que dieu veut et ce qui est utile au prochain, vous jouirez de la <span style="color: #9c6416;">liberté intérieure</span>.</p>
          <p>Si votre cœur était droit, alors toute créature vous serait un <span style="color: #9c6416;">miroir de vie</span> et un <span style="color: #9c6416;">livre rempli de saintes instructions</span>.</p>
          <p>Il n'est point de créature si petite et si vile qui ne présente quelque <span style="color: #9c6416;">image de la bonté de dieu</span>.</p>
          <p>Si vous aviez en vous assez d'<span style="color: #9c6416;">innocence</span> et de <span style="color: #9c6416;">pureté</span>, vous verriez tout <span style="color: #9c6416;">sans obstacle</span>.</p>
          <p>Un cœur pur pénètre le ciel et l'enfer.</p>
          <p>Chacun juge des choses du dehors selon ce qu'il est au-dedans de lui-même.</p>
          <p>S'il est quelque joie dans le monde, le cœur pur la possède.</p>
          <p>Et s'il y a des angoisses et des tribulations, avant tout elles sont connues de la mauvaise conscience.</p>
          <p>Comme le fer mis au feu perd sa rouille et devient tout étincelant, ainsi celui qui se donne sans réserve à dieu se dépouille de sa langueur et se change en un être nouveau.</p>
        </blockquote>
      </div>
      </article>
    </article></section>
    <section><article>
      <p>Dans l'œuvre de Memling, <strong>la conversation sacrée fonctionne selon cette simplicité et cette pureté dans l'espace représenté  autant par rapport aux spectateurs</strong> comme <span style="color: #e6a64d;"><strong>miroir de vie</span> entre l'espace du triptyque et l'espace des spectateurs</strong>:</p>
      <ul>
        <li>d'un côté les malades <span style="color: #e6a64d;">«<em>conversent</em>»</span> avec les figures représentées,</li>
        <li>de l'autre celles-ci <span style="color: #e6a64d;">«<em>apparaissent</em>»</span> ici et maintenant, comme Brugeoises et Brugeois de <time datetime="1479">1479</time>.</li>
      </ul>
      <p>La scène fonctionne comme aussi comme <span style="color: #e6a64d;">«livre rempli de saintes instructions»</span>:</p>
      <ul>
        <li><span style="color: #e6a64d;">simplicité et évidence spirituelles produisent</span> de manière merveilleuse et continue <span style="color: #e6a64d;">sophistication et opulence matérielles</span>.</li>
      </ul>
      ...
      <ul>
        <li><span style="color: #e6a64d;">«un monde de vierges vêtues de brocart d'or, de soie et d'hermine, couronnes dorées et de pierres précieses rares»</span> où <span style="color: #e6a64d;">«l'enfant Jésus fait signe»</span> aux malades dans une <span style="color: #e6a64d;">«atmosphère empreinte de profonde sérénité»</span>.</li>
      </ul>
      <p>De fait, simplicité et l'évidence ne connaissent pas de limites et mènent au divin.</p>
    </article></section>
  </article></section>
  <section><article>
...
<aside>
  ...
  <ol>
    <li id="fn:4">
    <article><p>Nous suivons les références données dans l'article «l'Imitation de Jésus-Christ» de Wikipedia (date de consultation: 21 août 2018), à savoir:</p>
    <ul>
...
<article>
  <h3 id="organisation-du-recit" class="yellow">organisation autour du récit pictural des légendes de Jean le Baptiste, Jean l'Évangéliste</h3>
  <section><article>
    ...
    <ul>
      ...
      <li>et représentant <span style="color: #e6a64d;">la place de la Grue</span> de Bruges liée au commanditaire, l'Hôpital Saint-Jean.</li>
    </ul>
  </article></section>
  ...
  <section><article>
    ...
    <figure>
      ...
      https://francois-vidit.com/user/sites/docs/pages/01.home/06.bruges/01.hopital-saint-jean/01.saint-jean/05.saint-jean_5/4-chapiteaux-1920.jpg 1920w"></picture><figcaption>détails du panneau central, de gauche à droite: les 4 châpiteaux</figcaption>
    </figure>
  </article></section>
...
<article>
  ...
  <p>«Le huitième jour, ils vinrent pour la circoncision de l’enfant, et ils voulaient l’appeler Zacharie, du nom de son père. Mais sa mère prit la parole, et dit:
...
<article>
  ...
  <p>Il mène ensuite une vie exemplaire d'ascète «dans le désert» <span style="color: #999;">(Luc 1,80)</span>.
  ...
  il préconise le pardon des péchés non plus par le sacrifice d'animaux au temple par crémation, mais par <span style="color: #e6a64d;">«baptême»</span>, c'est-à-dire, selon l'étymologie de ce mot, <span style="color: #e6a64d;">«immersion»</span> dans l'eau.</p>
  ...
  comme la foi judaïque regarde tout mariage avec la femme de son frère comme une <span style="color: #e6a64d;">«souillure»</span> et <span style="color: #e6a64d;">l'interdit</span> <span style="color: #999;">(Lévitique chap.18,16; chap.20,21)</span>, Jean le condamne publiquement.</p>
  <p><span style="color: #e6a64d;">Hérode craint</span> que cela ne suscite «<span style="color: #e6a64d;">une révolte</span>, la foule semblant prête à suivre en tout les conseils de cet homme.
  Il aime donc mieux s'emparer de lui avant que quelque trouble se produise à cause de lui, que d'avoir à se repentir plus tard si un mouvement avait lieu» <span style="color: #999;">(“Antiquités judaïques”, livre XVIII, chap.5,118)</span> <sup id="fnref1:2"><a href="#fn:2" class="footnote-ref">1</a></sup>.</p>
  ...
  <p>il donne <span style="color: #e6a64d;">«l’ordre d’arrêter Jean»</span> <span style="color: #999;">(Marc chap.6,17)</span>.</p>
  <figure><picture><source sizes="(max-width: 767px) 98vw, (min-width: 959px) 50vw, 86vw" srcset="
...
<article>
  ...
  «le jour de son anniversaire», il organise «un dîner pour ses dignitaires, pour les chefs de l’armée et pour les notables de la Galilée.</p>
  ...
  <p>Hérode fait mine que sa danse lui a plu et, <span style="color: #e6a64d;">pour se dégager de la responsabilité de la mort de Jean</span>, dit:</p>
  <p>«"<span style="color: #e6a64d;">Demande-moi ce que tu veux</span>, et je te le donnerai, même si c’est la moitié de mon royaume"» <span style="color: #999;">(Marc, chap.6,21-22)</span>.</p>
  <p>Salomé sort «pour dire à sa mère: <span style="color: #e6a64d;">"qu’est-ce que je vais demander?"</span>» Hérodiade répond: «<span style="color: #e6a64d;">"la tête de Jean, celui qui baptise"</span>. Aussitôt la jeune fille» s’empresse «de retourner auprès du roi, et lui» fait «cette demande: <span style="color: #e6a64d;">"Je veux que, tout de suite, tu me donnes sur un plat la tête de Jean le Baptiste"</span>. <span style="color: #999;">(Marc, chap.6,24-29)</span></p>
  <p>La preuve que tout ce récit est bien une mise en scène c'est que si Salomé demande à Hérode <span style="color: #e6a64d;">«la mort de son père <a href="https://fr.wikipedia.org/wiki/Hérode_Boëthos" title="https://fr.wikipedia.org/wiki/Hérode_Boëthos" id="herode-boethos-2" class="yellow">Philippe</a> ou de sa mère <a href="https://fr.wikipedia.org/wiki/Hérodiade" title="https://fr.wikipedia.org/wiki/Hérodiade" id="herodiade-2" class="yello">Hérodiade</a>»</span>, Hérode ne peut y consentir <span style="color: #999;">(Légende dorée chap.121,I. <sup id="fnref1:1"><a href="#fn:1" class="footnote-rf">1</a></sup> )</span>.  </p>
...
<article>
  ...
  <p>Le récit de Marc se poursuit <span style="color: #999;">(Marc,-29)</span>: <span style="color: #e6a64d;">«Ayant appris cela, les disciples de Jean vinrent prendre son corps et le déposèrent dans un tombeau»</span>.</p>
...
<article>
  ...
  <p>Selon ces documents et les spécialistes modernes, <span style="color: #e6a64d;">Jean l'Évangéliste peut désigner</span>:</p>
  <ol>
  ...
  <p>Aucun élément du texte ne permet de le nommer «Jean» donc l'apellation «évangile de Jean» ne peut être juste: ce devrait être l' «évangile du disciple que Jésus aimait».</p>
  ...
  <p>«Il y a encore beaucoup d’autres choses que Jésus a faites; et s’il fallait écrire chacune d’elles, <span style="color: #e6a64d;"><span style="text-decoration: underline;">je</span> pense que</span> le monde entier ne suffirait pas pour contenir les livres que l’on écrirait» <span style="color: #999;">(Jean 21.25)</span>.</p>
  <p>Jésus lui-même, à l'occasion d'une question de Pierre, émet un souhait quant à son destin lors de la Cène <span style="color: #999;">(Jean 21.21-23)</span>:
  «Pierre, voyant donc ce disciple, dit à Jésus:
  “Et lui, Seigneur, que lui arrivera-t-il?”
  Jésus lui répond:
  “Si <span style="color: #e6a64d;">je veux qu’il demeure jusqu’à ce que je vienne</span>, que t’importe?».</p>
  <p>C'est également lui qui «couché sur le sein de Jésus», il lui demande qui va le trahir <span style="color: #999;">(Jean 13.23-26)</span>.</p>
  <p>Lors de la crucifixion, Jésus lui confie sa propre mère, en disant: «Femme, voici ton fils», puis à lui: «Voici ta mère» <span style="color: #999;">(Jean 19.26-27)</span>.</p>
  <p>Quand Marie-Madeleine découvre le tombeau vide, elle court le dire au «disciple bien-aimé» et à Pierre; il est le premier à atteindre le tombeau <span style="color: #999;">(Jean 20.2-8)</span>.</p>
  ...
  <p>«<span style="color: #e6a64d;">Jean</span> préchait à Éphèse lorsqu'il est arrêté par le proconsul et invité à sacrifier aux dieux.
  ...
  Aussi, à cet endroit, les chrétiens ont-ils construit une église, et ce jour est-il fêté solennellement comme celui du martyre de Jean».</p>
  ...
  <p>«L'empereur, constatant qu'il ne renonçait pas à la prédication, l'exila dans <span style="color: #e6a64d;">l'île de Patmos</span>», <span style="color: #999;">(le départ pour Patmos apparaît au milieu: quelques hommes montent dans un bateau)</span> «où, dans la solitude, il écrivit <span style="color: #e6a64d;">l'Apocalypse</span>» <span style="color: #999;">(chap. 9)</span>.</p>
  ...
  <p>Il tient dans sa main une plume et un canif, sur ses genoux on voit un cahier.
  ...
  <tr><td><sup>07</sup></td>
  <td>Il s’avança et prit le livre dans la main droite de celui qui siégeait sur le trône.» <span style="color: #999;">(…)</span></p>
  <p>Le récit se poursuit entre l'arc-en-ciel et Jean.</td></tr>
...
<aside>
  ...
  <li id="fn:3">
  <p>Le texte de l'Apocalypse s'adresse aux «sept églises qui sont en Asie Mineure» («Éphèse, Smyrne, Pergame, Thyatire, Sardes, Philadelphie et Laodicée», Apocalypse 1.4) dans le langage symbolique des Écritures judaïques.</p>
...
<article>
  ...
  <tr><td><sup>15</sup></td>
  <td><span style="color: #e6a64d;">Les rois de la terre et les grands, les chefs d’armée, les riches et les puissants, tous les esclaves et les hommes libres allèrent se cacher dans les cavernes et les rochers des montagnes</span>.</td></tr>
  <tr><td><sup>16</sup></td>
  <td>Et ils disaient aux montagnes et aux rochers: «Tombez sur nous, et cachez-nous du regard de celui qui siège sur le trône et aussi de la colère de l’agneau.</td></tr>
  <tr><td><sup>17</sup></td>
...
<article>
  ...
  <tr><td><sup>01</sup></td>
  <td>Quand il ouvrit le septième sceau, il y eut dans le ciel un silence d’environ une demi-heure.</td></tr>
  <tr><td><sup>02</sup></td>
  ...
  <tbody>
  <tr><td><sup>04</sup></td>
  <td>Et par la main de l’ange monta devant dieu la fumée des parfums, avec les prières des saints.</td></tr>
  <tr><td><sup>05</sup></td>
  ...
  <tr><td><sup>06</sup></td>
  <td>Puis les sept anges qui avaient les sept trompettes se préparèrent à en sonner.</td></tr>
  <tr><td><sup>07</sup></td>
  <td>Le premier sonna de la trompette: il y eut de la grêle et du feu mêlés de sang, qui furent jetés sur la terre, et le tiers de la terre brûla, le tiers des arbres brûlèrent, toute l’herbe verte brûla.</td></tr>
  <tr><td><sup>08</sup></td>
  ...
  <tbody>
  <tr><td><sup>10</sup></td>
  <td>Le troisième ange sonna de la trompette: du ciel tomba <span style="color: #e6a64d;">une grande étoile qui flambait comme une torche</span>; elle tomba sur le tiers des fleuves et sur les sources des eaux.</td></tr>
  <tr><td><sup>11</sup></td>
...
<article>
  ...
  <tr><td><sup>01</sup></td>
  <td>Le cinquième ange sonna de la trompette, et j’ai vu une étoile qui était tombée du ciel sur la terre: c’est à elle que fut donnée la clé du <span style="color: #e6a64d;">puits de l’abîme</span>.</td></tr>
  <tr><td><sup>02</sup></td>
  <td>Elle ouvrit le puits de l’abîme, et du puits monta <span style="color: #e6a64d;">une fumée comme celle d’une grande fournaise</span>; le soleil et l’air furent obscurcis par la fumée du puits,</td></tr>
  <tr><td><sup>03</sup></td>
  <td>Et de la fumée sortirent vers la terre des <span style="color: #e6a64d;">sauterelles</span>; un pouvoir leur fut donné, pareil au pouvoir des scorpions de la terre.</td></tr>
  <tr><td><sup>04</sup></td>
  <td>Il leur fut dit de ne pas faire de mal à l’herbe de la terre, ni à la verdure, ni à aucun arbre, mais seulement aux hommes, ceux qui n’ont pas sur le front la marque du sceau de dieu.</td></tr>
  <tr><td><sup>05</sup></td>
  <td>Il leur fut donné, non pas de les tuer, mais de les tourmenter pendant cinq mois d’un tourment comme celui qu’inflige le scorpion quand il pique un homme.</td></tr>
  <tr><td><sup>06</sup></td>
  ...
  <tbody>
  <tr><td><sup>07</sup></td>
  <td>Ces sortes de <span style="color: #e6a64d;">sauterelles</span> ressemblent à des chevaux équipés pour la guerre; elles ont comme des couronnes d’or sur la tête, et un visage comme un visage humain,</td></tr>
  <tr><td><sup>08</sup></td>
  <td>Elles ont des cheveux comme des cheveux de femmes, leurs dents sont comme celles des lions.</td></tr>
  <tr><td><sup>09</sup></td>
  <td>Elles ont des poitrails comme des cuirasses de fer, et le bruit de leurs ailes est comme celui de chars à plusieurs chevaux courant au combat.</td></tr>
  <tr><td><sup>10</sup></td>
  <td>Elles ont des queues comme des scorpions, et des dards venimeux.
  Dans leur queue se trouve le pouvoir de faire du mal aux hommes pendant cinq mois.</td></tr>
  <tr><td><sup>11</sup></td>
  <td>Elles ont comme roi l’ange de l’abîme; il se nomme en hébreu Abaddôn et en grec Apollyôn (c’est-à-dire: Destructeur). <span style="color: #999;">(…)</span></td></tr>
  <tr><td></td><td><sup>chap.10</sup></td></tr>
  <tr><td><sup>01</sup></td>
  <td>Et j’ai vu un autre <span style="color: #e6a64d;">ange</span>, plein de force, descendre du ciel, ayant <span style="color: #e6a64d;">une nuée pour manteau</span>, et sur la tête <span style="color: #e6a64d;">un arc-en-ciel</span>; son visage était comme <span style="color: #e6a64d;">le soleil</span>, et ses jambes comme <span style="color: #e6a64d;">des colonnes de feu</span>.</td></tr>
  <tr><td><sup>02</sup></td>
  ...
  Et quand il cria, les sept tonnerres parlèrent, faisant résonner leur voix.</td></tr>
  <tr><td><sup>04</sup></td>
  <td>Et quand les sept tonnerres eurent parlé, j’allais me mettre à écrire; mais j’entendis une voix venant du ciel qui disait: «Ce que viennent de dire les sept tonnerres, garde-le scellé, ne l’écris pas!»</td></tr>
  <tr><td><sup>05</sup></td>
  ...
  <tr><td><sup>01</sup></td>
  <td>Un grand signe apparut dans le ciel: <span style="color: #e6a64d;">une femme</span>, ayant le soleil pour manteau, la lune sous les pieds, et sur la tête une couronne de douze étoiles.</td></tr>
  <tr><td><sup>02</sup></td>
  <td>Elle est enceinte, elle crie, dans les douleurs et la torture d’un enfantement.</td></tr>
  <tr><td><sup>03</sup></td>
  <td>Un autre signe apparut dans le ciel: <span style="color: #e6a64d;">un grand dragon</span>, rouge feu, avec sept têtes et dix cornes, et, sur chacune des sept têtes, un diadème.</td></tr>
  <tr><td><sup>04</sup></td>
...
<article>
  ...
  Car il est rejeté, l’accusateur de nos frères, lui qui les accusait, jour et nuit, devant notre dieu.</td></tr>
  <tr><td><sup>11</sup></td>
  ...
  Malheur à la terre et à la mer: le diable est descendu vers vous, plein d’une grande fureur; il sait qu’il lui reste peu de temps.»</td></tr>
  <tr><td><sup>13</sup></td>
  <td>Et quand le <span style="color: #e6a64d;">dragon</span> vit qu’il était jeté sur la terre, il se mit à poursuivre la <span style="color: #e6a64d;">femme</span> qui avait mis au monde l’enfant mâle.</td></tr>
  <tr><td><sup>14</sup></td>
...
<article>
  ...
  <p>Les revers des volets s'ornent des portraits des donateurs agenouillés et accompagnés de leurs saints patrons.</p>
  <p>Ils sont représentés dans des niches peu profondes.</p>
  <p>Ils ont tous été identifiés.</p>
  <p>On reconnaît, de gauche à droite:</p>
  <ul>
  ...
  <p>Le triptyque fut probablement commandé avant 1475, puisque c'est au cours de cette année-là que mourut Antoine SEGHERS.</p>
  <p>Il fut placé au-dessus du maître-autel en 1479.</p>
</article>
...
<article>
  ...
  Catherine, fille du roi Costus, fut instruite en tous les <a href="#note_artsliberaux" title="les sept arts libéraux" id="artsliberaux" class="yellow">arts libéraux</a>.</p>
  ...
  Elle ordonna à un messager d'aller promptement s'informer de ce qui se passait.</p>
  ...
  <p>Enfin, il reint à lui et lui dit:</p>
  <table>
  <thead>
  <tr>
  <th></th>
  ...
  <p>La reine, vivement éprise du général des armées, nommé Porphyre, se rendit vers minuit dans la prison de la vierge.</p>
  <p>Quand elle y entra, elle vit que la prison resplendissait d'une incroyable clarté et que des anges pansaient les blessures de la vierge.</p>
  <p>La vierge commença à lui prêcher les joies éternelles, la convertit à la foi et lui prédit la couronne du martyre et ainsi, ils poursuivirent leur entretien jusqu'au milieu de la nuit.</p>
  <p>Porphyre, qui avait entendu tout cela, se jeta aux pieds de la vierge et reçut la foi en même temps que deux cents soldats.</p>
  ...
  celles de dessous tiraient en déchirant et celles de dessus, qui s'opposaient à ce mouvement, repoussaient en broyant.</p>
  <p>Alors la sainte vierge pria le Seigneur de détruire cette machine pour l'exaltation de son propre nom et pour la conversion du peuple qui l'entourait.</p>
  <p>Et voilà qu'un ange du Seigneur frappa et brisa cette meule avec tant de force qu'il tua quatre mille païens.</p>
  <p>La reine, qui regardait la scène d'un lieu élevé et qui, jusque-là, s'était cachée, descendit aussitôt et reprocha très durement à l'empereur cette si grande cruauté.</p>
  ...
  <p>Porphyre prit son corps et l'ensevelit.</p>
  ...
  <p>Elle souffrit sous le tyran Maxence ou <a href="#note_maximinus" title="Maximin" id="maximinus" class="yellow">Maximin</a>, qui commença à régner vers l'an du Seigneur 310.</p>
  ...
  <p>On rapporte qu'un moine de <a href="#note_rouen" title="Rothomagus" id="rouen" class="yellow">Rothomagus</a> se rendit au mont Sinaï et qu'il demeura là pendant sept ans en se vouant au service de <span style="color: #df8f20;">sainte Catherne</span>.</p>
  <p>Comme il lui demandait avec beaucoup d'ardeur de mériter de posséder quelque fragment de son corps, aussitôt une phalange se détacha d'un de ses doigts.</p>
  <p>Tout heureux, il reçut ce don de Dieu et l'emporta vers son monastère.</p>
  ...
  mais, avec le cours du temps, il se relâcha par négligence, perdit sa dévotion d'esprit et cessa de l'invoquer.</p>
  <p>Un jour qu'il était en prière, il vit passer devant lui une foule de vierges, dont l'une paraissait plus resplendissante que les autres.</p>
  <p>Mais quand elle approcha de lui, elle se cacha le visage et, ainsi joilée, passa devant lui.</p>
  <p>Comme il admirait fort son éclat
  et demandait qui elle était, l'une des vierges lui répondit:</p>
  <p><span style="color: #577575;">«C'est Catherine, que tu connaissais bien jadis;
  ...
  <p>En <span style="color: #936c93;">premier lieu</span>, elle manifeste son caractère admirable par sa <span style="color: #936c93;">sagesse</span>.</p>
  <p>En elle, en effet, on trouve toutes les sortes de philosophie.
  Car la philosophie ou sagesse se divise en <span style="color: #6c8993;">philosophies théorique</span>, <span style="color: #6c8993;">pratique</span> et <span style="color: #6c8993;">logique</span>.</p>
  <p>Pour certains, la <span style="color: #6c8993;">philosophie théorique</span> se divise en <span style="color: #93896c;">trois philosophies</span>: <span style="color: #93896c;">intellectuelle</span>, <span style="color: #93896c;">naturelle</span> et <span style="color: #93896c;">mathématique</span>.</p>
  ...
  <p>Troisièmement, elle a joui de <span style="color: #936c93;">la sagesse mathématique</span>, en méprisant les choses terrestres, car, selon <a href="#note_boece" title="Boèce" id="boece" class="yellow">Boèce</a>, cette science considère les formes sans la matière.</p>
  <p><span style="color: #df8f20;">Sainte Catherine</span> a oui de cette science quand elle a tiré son esprit de tout attachement matériel.</p>
  <p>Elle a manifesté la possession de cette sagesse quand elle a répondu à l'empereur qui l'interrogeait:</p>
  <p><span style="color: #577575;">«Je suis Catherine, fille du roi Costus;
  bien que née dans la pourpre, etc.»</span></p>
  <p>Elle a surtout usé de cette sagesse avec la reine,
  ...
  La première enseigne comment réformer ses mœurs, s'orner de vertus, et elle s'adresse à tous.</p>
  <p>La deuxième enseigne la bonne direction de la famille et s'adresse aux pères de famille.</p>
  <p>La troisième apprend à bien gouverner les villes, les peuples et l'État.</p>
  <p><span style="color: #df8f20;">Sainte Catherine</span> a joui aussi de cette triple science:
  elle a joui de la première quand elle a su se conduire avec toute l'honnêteté possible de ses mœurs.</p>
  <p>Elle a joui de la deuxième quand elle a dirigé de louable façon la maison nombreuse qui lui avait été laissée.</p>
  <p>Elle a joui de la troisième quand elle a donné un sage enseignement à l'empereur.</p>
  ...
  comme on le voit dans ses paroles à l'empereur:</p>
  <p>«Tu admires ce temple fait de la main des artisans, etc.»</p>
  <p>Son éloquence fut aussi très douce dans la persuasion,
  ...
  <p>En <span style="color: #936c93;">troisième lieu</span>, elle fut admirable de <span style="color: #936c93;">constance</span>.</p>
  <p>Elle se montra en effet très constante devant les menaces,
  ...
  <p>En effet, elle conserva sa chasteté en des circonstances où, d'habitude, la chasteté faiblit.</p>
  <p>Il y a en effet cinq circonstances
  ...
  <p>Sur ces quatre circonstances, il a été dit, plus haut:</p>
  <p>«Catherine, âgée de dix-huit ans, se trouvait seule dans un palais rempli de richesses et d'esclaves.»</p>
  <p>Elle jouissait aussi de la beauté,
  puisqu'on a dit qu'
  «elle était très jolie
  et, par sa beauté incroyable, elle paraissait admirable aux yeux de tous».</p>
  <p>En <span style="color: #936c93;">cinquième lieu</span>, elle fut admirable par le <span style="color: #936c93;">privilège de sa dignité</span>.</p>
  <p>En effet,
  ...
  fut-elle martyrisée sous Maxence ou sous Maximin?</p>
  <p>À cette époque trois hommes gouvernaient l'Empire: </p>
  <ul>
...
<aside>
  ...
  <p>retour à la note: <a href="#rouen" title="Rothomagus">Rothomagus↑</a></p>
  </div>
  ...
  <p>retour à la note: <a href="#jean" title="福音書記者ヨハネ">Jean l'Évangéliste↑</a></p>
  </div>
  ...
  <p>renvoi au texte　<a href="#maxentius" title="Maxence">Maxence↑</a></p>
  </div>
  ...
  <p>renvoi au texte　<a href="#sybille" title="la Sibylle">la Sibylle</a></p>
  </div>
  ...
  <p>renvoi au texte　<a href="#rouen" title="Rothomagus">Rothomagus↑</a></p>
  </div>
  ...
  <p>renvoi au texte　<a href="#sinai" title="l'emportèrent jusqu'au mont Sinaï et l'ensevelirent là">l'emportèrent jusqu'au mont Sinaï et l'ensevelirent là↑</a></p>
  </div>
  ...
  <p>renvoi au texte　<a href="#boece" title="Boèce">Boèce↑</a></p>
  </div>
  ...
  <p>renvoi au texte　<a href="#constantin" title="Constantin">Constantin↑</a></p>
  </div>
  ...
  <p>renvoi au texte　<a href="#incarnation" title="l'Incarnation">l'Incarnation↑</a></p>
  </div>
</aside>
...
<article>
  ...
  <p>Le serviteur de Dieu la salua au nom de Jésus-Christ.</p>
  ...
  et il lui remit les livres envoyés par Origène.</p>
  <p>Elle s'appliqua beaucoup à les lire,
  ...
  et elle fut transportée sur une montagne où étaient deux bergers qui faisaient paître leurs brebis.</p>
  <p>Son père se mit à sa recherche, et il alla vers ces bergers et il leur demanda s'ils avaient vu sa fille.</p>
  <p>L'un d'eux, voyant combien le père était irrité parce qu'il ne savait point où elle était, se tut; l'autre l'indiqua du doigt.</p>
  <p><span style="color: #994c3d;">Sainte Barbe</span> maudit celui qui l'avait trahie,
  et sur-le-champ il fut changé en statue de marbre,
  et ses brebis furent métamorphosées en sauterelles;
  mais ce récit est apocryphe.</p>
  <p>Son père, la trouvant, la battit, la traina par les cheveux
  et la chargea de chaînes.</p>
  <p>Il l'enferma dans un cachot
  et y mit des gardes,
  ...
  qui fit prisonnier son ennemi et qui l'enferma dans une tour, en défendant, sous les peines les plus grndes, que personne lui donnat à boire ni à manger.</p>
  <p>Après qu'il y fut resté quelques jours,
  ...
  et tous ceux qui étaient présents s'enfuirent, saisis de crainte.</p>
  ...
  et son confesseur ayant reconnu qu'il était innocent, l'engagea à se vouer au service de <span style="color: #994c3d;">sainte Barbe</span>, et à promettre de ne pas revenir chez lui avant d'avoir fait un pèlerinage en son honneur.</p>
  <p>La femme réclamait à grands cris un jugement, et les juges s'étant réunis et ayant fait comparaître devant eux l'accusé, le condamnèrent à mort;
  alors il se présenta quelqu'un que personne ne connaissait, et qui, ayant demandé la parole, prouva, par des raisons pertinentes et irrécusables, que le soldat n'était point coupable et que la sentence était injuste.</p>
...
<article>
  ...
  <p>En effet, le Christ l'a aimé plus que les autres apôtres et lui a montré de plus grands signes d'amour et d'intimité.</p>
  <p>C'est pour cela qu'il est nommé «grâce du Seigneur»: il a plu au Seigneur.</p>
  <p>Dieu semble même l'avoir plus aimé que Pierre.</p>
  <p>Mais on distingue l'amour de cœur et l'amour exprimé.</p>
  <p>Cet amour exprimé se déclare soit dans la manifestation d'une intimité, soit dans la distribution de bienfaits.</p>
  <p>Or, pour ce qui est de l'amour de cœur, Dieu aima également Pierre et <span style="color: #994c3d;">Jean</span>; pour ce qui est de la manifestation de l'intimité, il aima plus <span style="color: #994c3d;">Jean</span> que Pierre, et, pour la distribution des bienfaits, il préféra Pierre.</p>
  ...
  Car en lui se trouva la grâce de la pudeur virginale.</p>
  <p>Il fut appelé par le Seigneur au moment où il voulait se marier.</p>
  <p>Le <span style="color: #994c3d;">troisième</span> privilège réside dans la <span style="color: #994c3d;">révélation des secrets</span>.</p>
  <p>C'est ce qui le fait nommer «celui à qui l'on a fait un don».</p>
  ...
  <p><span style="color: #994c3d;">Jean</span> leur proposa cette alternative: </p>
  <ul>
  ...
  ils rendirent l'âme.</p>
  <p>Alors l'apôtre prit le calice et,
