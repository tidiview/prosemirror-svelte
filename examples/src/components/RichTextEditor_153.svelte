...
<h1 class="red"><a href="/blog/fr/fontenelle" rel="bookmark">premier soir des “entretiens sur la pluralité des mondes”, 1686</a></h1>
...
<div class="notices red">
<p>Pour «instruire et divertir tout ensemble», Fontenelle présente les dernières découvertes astronomiques dans un dialogue galant.<br>
...
la fait rêver, aux mouvements des astres et à la pluralité des mondes habités, «mondes possibles» dit-il.<br>
Il lui dévoile le système de Copernic encore contesté à l'époque qui fait de la Terre une planète parmi les autres, tournant autour d'un Soleil qui n'est lui-même qu’une étoile parmi une infinité d'autres semblables.<br>
Le charme de ce court ouvrage tient à un mélange habile de considérations scientifiques et métaphysiques et de galanteries.</p>
<p>Nommé à l’Académie des Sciences en 1697, Fontenelle actualisera son ouvrage des découvertes les plus récentes.<br>
Le succès est exceptionnel:
trente-trois éditions du vivant de Fontenelle!<br>
Mais son influence lui vient surtout de sa puissance critique.<br>
...
<p>Pour délivrer sa première leçon, le philosophe use d'une longue métaphore filée, assimilant la nature au spectacle de l'Opéra.<br>
...
<h2 class="red">premier soir, page 8</h2>
...
<p>Il n'y a peut-être que quelque machiniste caché dans le parterre (2 Rez-de-chaussée d'une salle de théâtre où le public se tenait debout et où les places étaient moins chères que dans les loges.), qui s'inquiète d’un vol qui lui aura paru extraordinaire et qui veut absolument démêler comment ce vol a été exécuté.
...
<p>L'un d'eux disait: «c'est une certaine vertu secrète qui enlève Phaeton».</p>
<p>L'autre: «Phaéton est composé de certains nombres qui le font monter».</p>
<p>L'autre: «Phaéton a une certaine amitié pour le haut du théâtre; il n’est point à son aise quand il n’y est pas».</p>
<p>L'autre: «Phaéton n’est pas fait pour voler, mais il aime mieux voler, que de laisser le haut du théâtre vide? ; et cent autres rêveries que je m'étonne qui n'aient perdu de réputation toute l'Antiquité.</p>
<p>À la fin Descartes, et quelques autres modernes sont venus, qui ont dit: «Phaéton monte, parce qu'il est tiré par des cordes, et qu’un poids plus pesant que lui descend».</p>
