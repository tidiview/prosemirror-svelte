...
<section><article>
  ...
  <section><article>
    <p>From that point on, his story turns to tragedy.</p>
...
<article>
  ...
  <section><article>
    ...
    <section><article>
      ...
      <p>A guard is going to «behead John in the prison» <span style="color: #999;">(Mark, chapter 6, verse 28)</span>.</p>
    </article></section>
...
<article>
  ...
  <h2 class="yellow" id="st-john-the-evangelist-according-to-the-golden-legend">John the Evangelist according to chapter 9 of <cite>The Golden Legend</cite></h2>
  <section><article>
    <h3>Text of Chapter 9. of <cite>The Golden Legend</cite>: <cite>Legend of John the Evangelist</cite></h3>
