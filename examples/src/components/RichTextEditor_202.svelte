...
<figure>
  ...
  <h2 class="yellow"><cite>Perseus and Andromeda</cite> according to <cite>The Metamorphoses</cite></h2>
    ...
    <ol class="doc">
      ...
      <li>As soon as Perseus, great-grandson of Abas, saw her fastened by her arms to the hard rock,</li>
      <li value="675">
      he would have thought she was a marble statue, except that a light breeze stirred her hair, and warm tears ran from her eyes.</li>
      ...
      <li>As soon as he had touched down, he said ‘O, you do not deserve these chains, but those that link ardent lovers together.</li>
      <li value="680">Tell me your name, I wish to know it, and the name of your country, and why you are wearing these fetters.</li>
      ...
      <li>Before she had finished speaking, all the waves resounded, and a monster menaced them, rising from the deep sea, and</li>
      <li value="690">
      covered the wide waters with its breadth.</li>
      ...
      <li value="695">Then the stranger speaks ‘There will be plenty of time left for tears, but only a brief hour is given us to work.</li>
      <li>If I asked for this girl as Perseus, son of Jupiter and that Danaë, imprisoned in the brazen tower, whom Jupiter filled with his rich golden shower; Perseus conqueror of the Gorgon with snakes for hair, he who dared to fly, driven through the air,</li>
      <li value="700">
      on soaring wings, then surely I should be preferred to all other suitors as a son-in-law.</li>
      <li>If the gods favour me, I will try to add further merit to these great gifts. I will make a bargain.</li>
      <li>Rescued by my courage, she must be mine.’</li>
      <li>Her parents accept the contract (who would hesitate?) and, entreating him,</li>
      <li value="705">
      promise a kingdom, as well, for a dowry.</li>
      <li>See how the creature comes, parting the waves with surging breast, like a fast ship with pointed prow ploughing the water, driven by the sweat-covered muscles of her crew.</li>
      ...
      <li value="720">
      in the right side of its neck.</li>
      ...
      <li>The shores, and the high places of the gods,</li>
      ...
      <li>To the three gods, he builds the same number of altars out of turf, to you Mercury on the left, to you Minerva, warlike virgin, on the right,</li>
