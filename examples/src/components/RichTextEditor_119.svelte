...
そうなったらあの<a href="#note_paris" title="パリス" id="paris">羊飼の少</a>年が、この私の世に類ない<ruby>麗容<rp>(</rp><rt>あですがた</rt><rp>)</rp></ruby>を、他の二柱の女神たちよりずっと上に置いてくれたのもなんにもなりはしない、ユッピテルさまだって、あの子の<ruby>判断<rp>(</rp><rt>みわけ</rt><rp>)</rp></ruby>は正当で確かなものだと言って下さったのにさ。</p>
<p>でもまあ、どんな女にもせよ、いつまでも好い気でもって私の栄誉を横奪りはさせとかないからね、見るがいいさ、いまにかえって自分の道に外れた<ruby>容色<rp>(</rp><rt>かおかたち</rt><rp>)</rp></ruby>を後悔するようにしてやるから。」</p>
<p>そこでヴェヌスは早速と自分の息子（<ruby>愛の神<rp>(</rp><rt>クピードー</rt><rp>)</rp></ruby>）を呼び寄せました。
...
その<ruby>松明<rp>(</rp><rt>たいまつ</rt><rp>)</rp></ruby>の輝きも<a href="#note_flammeum" title="緋色の面帕" id="suie">黒い<ruby>煤<rp>(</rp><rt>すす</rt><rp>)</rp></ruby></a>の燃えくずで<ruby>朧<rp>(</rp><rt>おぼろ</rt><rp>)</rp></ruby>にかすみ、婚礼の祝い笛の音もいつしか物悲しい<a href="https://ja.wikipedia.org/wiki/リュディア" title="https://ja.wikipedia.org/wiki/リュディア"><ruby lang="ja">リュディア<rp>(</rp><rt lang="grc">Λυδία</rt><rp>)</rp></ruby lang="ja"></a>風のかごとに変ってゆきます、陽気な嫁入<ruby>唄<rp>(</rp><rt>うた</rt><rp>)</rp></ruby>もついには<ruby>陰<rp>(</rp><rt>いん</rt><rp>)</rp>鬱<rp>(</rp><rt>うつ</rt><rp>)</rp></ruby>な<ruby>衰<rp>(</rp><rt>あい</rt><rp>)</rp>悼<rp>(</rp><rt>とう</rt><rp>)</rp></ruby>の叫びごえと<ruby>化<rp>(</rp><rt>な</rt><rp>)</rp></ruby>ってしまって、お嫁入りするはずの少女が、なんということでしょう、（婚礼の）<a href="https://ja.wikipedia.org/wiki/呉茂一" title="https://ja.wikipedia.org/wiki/呉茂一" id="flammeum"><ruby>緋<rp>(</rp><rt>ひ</rt><rp>)</rp>色<rp>(</rp><rt>いろ</rt><rp>)</rp></ruby>の<ruby>面帕<rp>(</rp><rt>かおぎね</rt><rp>)</rp></ruby></a>でそっと涙を拭いてるという始末です。</p>
<p>こうした不仕合せな王家の悲しい御運に、町中の人々ももろとも<ruby>歎<rp>(</rp><rt>なげ</rt><rp>)</rp></ruby>きをお頒けし、皆々の<ruby>哀<rp>(</rp><rt>あい</rt><rp>)</rp>痛<rp>(</rp><rt>つう</rt><rp>)</rp></ruby>から、やがてその日は誰彼となく仕事を休んで、喪に<ruby>服<rp>(</rp><rt>つ</rt><rp>)</rp></ruby>くという布令をいたしました。</p>
<p><sup>３４</sup>
しかし神様の<ruby>御<rp>(</rp><rt>お</rt><rp>)</rp>令<rp>(</rp><rt>いいつけ</rt><rp>)</rp></ruby>には従うよりありませんので、可哀そうにプシケは定められた<ruby>処<rp>(</rp><rt>し</rt><rp>)</rp>置<rp>(</rp><rt>おき</rt><rp>)</rp></ruby>をよんどころなく受けることになって、お<ruby>葬<rp>(</rp><rt>とむら</rt><rp>)</rp></ruby>いじみた婚礼の儀式を一同の<ruby>劇<rp>(</rp><rt>はげ</rt><rp>)</rp></ruby>しい悲しみの中にも残りなく執り行ったうえ、町中の人を後ろに引き<ruby>随<rp>(</rp><rt>したが</rt><rp>)</rp></ruby>えて生きながらの葬式が宮殿から繰り出され、こうやってプシケは涙ながらに嫁入りではなくて、自分の法事に連れてゆかれたのでございます。
さて悲歎にくれた両親があまりの<ruby>不<rp>(</rp><rt>ふ</rt><rp>)</rp>憫<rp>(</rp><rt>びん</rt><rp>)</rp></ruby>さに心もくじけて、この酷たらしい<ruby>所<rp>(</rp><rt>しょ</rt><rp>)</rp>業<rp>(</rp><rt>ぎょう</rt><rp>)</rp></ruby>をやり<ruby>徹<rp>(</rp><rt>とお</rt><rp>)</rp></ruby>すのをためらってますと、かえって娘の方がこういって両親を励ますのでした。</p>
<p>「なぜお二人ともお年を召して不運なおからだを、長いこと泣き悲しんでお傷めになるのですの、どうしてあなた様方のお心を、それもまあ私のものともいえますのに、ひっきりなしに歎きつづけてお責め立てになりますの、どうして甲斐もない涙でもって、大切な尊いお顔をお汚しなさいますの、なぜお眼をいためつけて、（これを見る）私の眼をお苦しめになるのです、どうしてまた白いお<ruby>髪<rp>(</rp><rt>きじ</rt><rp>)</rp></ruby>を<ruby>掻<rp>(</rp><rt>か</rt><rp>)</rp></ruby>きむしったり、お胸を、尊い乳房をお撃ちなさいますの。</p>
<p>これがこの私の人並み勝れた<ruby>容色<rp>(</rp><rt>きりょう</rt><rp>)</rp></ruby>の立派な御褒美として、あなた様方のお受けになったものでございました。
...
何もそれを引っぱっておくことも、やって来る者を拒むこともございませんもの、その全世界を滅ぼすために生れたというひとを。」</p>
<p><sup>３５</sup>
こう言いきると少女はロを<ruby>噤<rp>(</rp><rt>つぐ</rt><rp>)</rp></ruby>んで、足どりも<ruby>慥<rp>(</rp><rt>たし</rt><rp>)</rp></ruby>かに、ついてゆく人々の行列の中へとはいり込みました。
...
こんなに沢山な宝石や珠玉の上を<ruby>履<rp>(</rp><rt>ふく</rt><rp>)</rp></ruby>んで歩く人は、きっと幾度も祝福された仕合せ者に違いないと言いきれます。</p>
<p>御殿の外の部分も見渡す限り値打もわからないほど立派に飾られ、どの<ruby>障壁<rp>(</rp><rt>かべ</rt><rp>)</rp></ruby>も金の大板で固めてあって、その<ruby>燦<rp>(</rp><rt>きらめ</rt><rp>)</rp></ruby>きといったらまるで太陽も<ruby>射<rp>(</rp><rt>さ</rt><rp>)</rp></ruby>さないのに、御殿中が自分の明りで日中のように照りわたるほどです。
寝間も玄関も扉さえもその通りきらきらと輝いていますし、また御殿のよその方もこれに劣らず結構を尽して、まさしくこれこそユッピテル大神さまが、人間界に御<ruby>下<rp>(</rp><rt>か</rt><rp>)</rp>降<rp>(</rp><rt>こう</rt><rp>)</rp></ruby>なさる時のため造営になった天の宮居かとも思われるのでした。</p>
<p><sup>２</sup>
その景色の<ruby>愉<rp>(</rp><rt>たの</rt><rp>)</rp></ruby>しさに<ruby>誘<rp>(</rp><rt>つ</rt><rp>)</rp></ruby>りこまれて、プシケはもっと傍へと近寄って見ました。だんだんと気安くなってとうとう<ruby>閾<rp>(</rp><rt>しきい</rt><rp>)</rp></ruby>のなかへはいって参りますと、<ruby>忽<rp>(</rp><rt>たちま</rt><rp>)</rp></ruby>ちによのつねならず美しいその有様に心を奪われ、さて熱心に次々と覗き見をしてゆくうち、建物の向う側に立派な腕前で造り上げた大きな倉があって、沢山な御宝物でぎっしりと詰まってるのが目につきました。
どんな品物でも（世界にある宝で）その中にないものとてありません。
けれども、その目を<ruby>瞠<rp>(</rp><rt>みは</rt><rp>)</rp></ruby>らせる豪勢な財宝もさることながら、とりわけて不思議なのは、この世界中のお宝が集めてあるところに、何の鎖も錠前も、番人さえも附いていないことです。</p>
<p>その間をプシケが<ruby>悦<rp>(</rp><rt>うれ</rt><rp>)</rp></ruby>しさに夢中になって観てまいりますと、（どこからか）姿も見えない声が聞えて申しますには、</p>
<p>「奥様、なぜこの沢山な<ruby>財宝<rp>(</rp><rt>おたから</rt><rp>)</rp></ruby>を見てびっくりなさいますの、これはみんなあなた様のものでございますのに。ですからさあ寝間にいらして、十分に<ruby>寝<rp>(</rp><rt>やす</rt><rp>)</rp></ruby>んでお疲れをお癒しになってから、お気が向いたらお風呂におはいり下さいまし。
いまお聞きになっておいでの声は、私どもあなた様の<ruby>侍女<rp>(</rp><rt>こしもと</rt><rp>)</rp></ruby>たちで、これからはまめまめしくお仕え致しますが、お体がすっかり元気におなりでしたら、すぐと立派な御馳走をさし上げることになっておりますから。」と申します。</p>
<p><sup>３</sup>
形のない声のいうことを聞いてプシケは、これはきっと神様のお心づけから出た、恵み深いお指図であろうと悟りましたので、まずよく寝んで、それから今度はお湯にはいり疲れを癒した後、ふと見るとすぐ手近に半円形のソーファがあって、そこにはいろいろな食事の道具がお<ruby>食<rp>(</rp><rt>あが</rt><rp>)</rp></ruby>り下さいといわぬばかりに並べてあります。
...
誰一人姿は見えず、ただ落ちてくる言葉だけが聞えて、つまり声ばかりがお給仕を勤めるわけなのです。</p>
<p>立派な御馳走のあとで、誰かがはいって来るけはいで歌を唱いましたが、姿は見えません、また誰かが堅琴を弾くのですがその琴の形も見えませんでした。
それから今度は多勢が一所に集って合唱する声が聞えてきて、誰も人の形は見えないながら、確かに<ruby>歌舞<rp>(</rp><rt>コロス</rt><rp>)</rp></ruby>の群がその辺にいる様子でした。</p>
<p><sup>４</sup>
その娯しみもお終いになると、タ暮の誘いにまかせてプシケは<ruby>臥<rp>(</rp><rt>が</rt><rp>)</rp>床<rp>(</rp><rt>しょう</rt><rp>)</rp></ruby>にはいりました。
...
いかような災難被害よりもずっと怖く思うのでした。</p>
<p>とうとうまだ見も知らぬ良人が現れて台に上り、プシケを新妻として迎えいたわると、夜も明けないうちに急いで出かけてしまいました。
とすぐに声たちが寝間へ来て、花嫁のお世話をいたし、<ruby>少女<rp>(</rp><rt>おとめ</rt><rp>)</rp></ruby>気のさまざまに乱れたこころを慰めるのでした。</p>
<p>こういう風にして長いこと暮しているあいだに、いつしかだんだんと自然に馴れて、初めには奇妙と思われたことも始終なれっこになると楽しみに感ぜられてくるというわけ、声だけの者もいつの間にか様子なれない寂しさの慰めと変ってくる有様でした。</p>
<p>さて一方姫の御両親は、絶える間もない悲歎のあまり、<ruby>遽<rp>(</rp><rt>すみや</rt><rp>)</rp></ruby>かにひどく老けておしまいになって、その噂が段々と弘がってゆき、ついには二人の姉姫の耳にも始終のこらず伝わりましたので、それを聞いた二人の姉達は大そう心配をして胸を痛め、執るものもとりあえず自分の家を発つと、互いに遅れじと両親のところへお見舞に出かけて参りました。</p>
<p><sup>５</sup>
ちょうどその晩、プシケに向って良人はこう申し出ました、眼では姿が見えないながらに、手や耳やでもってすれば、十分に理解はつくわけでしたので——「本当に優しいプシケ、私の可愛い妻よ、運命の<ruby>女神<rp>(</rp><rt>フォルトゥーナ</rt><rp>)</rp></ruby>は前よりも一層意地悪く、お前に命も危いほどの難儀をさせようとしてるのだから、もっともっと十分に気をつけて用心しなくてはいけないよ。
...
さもないと私には酷い歎きをかけることになるうえ、お前自身にも取り返しがつかない破滅を招く仕儀になろうから。」</p>
<p><ruby>少女<rp>(</rp><rt>おとめ</rt><rp>)</rp></ruby>は<ruby>点頭<rp>(</rp><rt>うなず</rt><rp>)</rp></ruby>いて良人の意見通りにする約束をしましたものの、夜と一緒に良人の姿が消えてくと、一日じゅうあわれ気に涙を<ruby>労<rp>(</rp><rt>いた</rt><rp>)</rp></ruby>し胸を叩いて日を過ごし、もう自分には何一つ生きた甲斐もないように言い暮しては歎くのでした。
自分はもう楽しげな牢屋の中に閉じ籠められて人間と話をすることも差し止められてる上に、姉妹とさえ、それも自分のことを泣き悲しんでいてくれるのに、<ruby>労<rp>(</rp><rt>いた</rt><rp>)</rp></ruby>わり慰めることはおろか、ひと目なり会うこともできないなんて——こう言ってお風呂にもはいらず食事もせずに、何をして心を慰めるともなく、ただひたすらに泣きつくしたあげく、やっと寝床にはいりました。</p>
<p><sup>６</sup>
程もなく<ruby>平常<rp>(</rp><rt>いつも</rt><rp>)</rp></ruby>より一寸早目に良人が傍に参りまして、まだ泣き濡れている<ruby>少女<rp>(</rp><rt>おとめ</rt><rp>)</rp></ruby>を優しく抱きながら、<ruby>咎<rp>(</rp><rt>とが</rt><rp>)</rp></ruby>めだてて申しますには、</p>
<p>「これがお前のした約束だったのかえ、プシケ、一体お前は私にどうしてくれというの。
...
ただあとで後悔しだしてももう遅いときに、私が本気になって戒めといたことだけは、忘れないでいておくれ。」</p>
<p>そうすると少女は<ruby>頻<rp>(</rp><rt>しき</rt><rp>)</rp></ruby>りにせがんだり、はてはもう死んでしまうといって脅したりして、とうとう良人に自分の頼みを<ruby>肯<rp>(</rp><rt>き</rt><rp>)</rp></ruby>かせてしまいました。
...
<p>プシケは幾分元気を取り返し、良人に礼を言ってまた申しますには、「まあ、あなた様とこうして楽しく暮せなくなるくらいなら、いっそ私は百度もその前に死んでしまいますわ。
...
そのいとし<ruby>愛<rp>(</rp><rt>かな</rt><rp>)</rp></ruby>しい{r}密語(ささめき{/r)}の力にひかされ、心ならずも良人は説き伏せられて、何でも望みのことをしてやる約束をしてから、朝の光がさし寄るままにまた妻のかいなから姿をかくしてゆきました。</p>
<p><sup>７</sup>
さて一方、姉達はというと、例の<ruby>巖<rp>(</rp><rt>いわお</rt><rp>)</rp></ruby>の、プシケが置きざりにされた場処を訊ね出して急いでやってき、そこで眼を泣き腫らし胸を撃って歎くことといったら、あんまりひっきりなしに<ruby>喚<rp>(</rp><rt>わめ</rt><rp>)</rp></ruby>き立てるので、岩や石やがお互いに<ruby>反響<rp>(</rp><rt>こだま</rt><rp>)</rp></ruby>しあうほどでした。
...
ですから、どうかそんな情けない声をお立てにならずと、長いこと泣いて濡れたお顔も乾かして下さいましな、だって今しがたまで<ruby>悼<rp>(</rp><rt>くや</rt><rp>)</rp></ruby>んで下さった私を、もう胸に抱きしめて下されるのですもの。」</p>
<p>で<ruby>西風<rp>(</rp><rt>ゼフィルス</rt><rp>)</rp></ruby>を呼んで良人の<ruby>命令<rp>(</rp><rt>いいつけ</rt><rp>)</rp></ruby>を伝えますと、待つ程もなく指図の通りに、この上もなく穏やかな風に載せて、何の障りもなく姉達を運び下ろしてくれました。
三人の姉妹はそこでお互いに抱きあったり忙しい<ruby>接吻<rp>(</rp><rt>くちづけ</rt><rp>)</rp></ruby>を交わしたりして喜びあうひまにも、一度は納まっていた涙がまた新規な嬉しさまのあまり湧きかえるのでした。
「とにかくまあ<ruby>家<rp>(</rp><rt>うち</rt><rp>)</rp></ruby>のなかへ機嫌を直しておはいりになって、姉さまのプシケと一緒に、うっとうしいお気持ちをさっぱりなさってくださいまし。」</p>
<p><sup>８</sup>
こう言って（プシケは姉達を家の中へ連れ込み）、金色の御殿中の大へんな宝物を見せたり、声ばかりでかしずいてくれる沢山な<ruby>侍女<rp>(</rp><rt>こしもと</rt><rp>)</rp></ruby>を姉達の耳へ引き合せたりした上、結構を極めた風呂や人界のものとも思えない立派な御馳走の数々で心ゆくばかり<ruby>接待<rp>(</rp><rt>もてな</rt><rp>)</rp></ruby>しますと、姉たちはこういろんなお宝が天国そのままにどっさりと溢れるほど一杯ある様子に呆れ果てて、今は心の奥深くひそかに嫉み心を強めてゆくのでした。
...
そしてまた長く喋っていてうっかり胸の秘密をさらけ出しなどしないようにと、金の<ruby>器具<rp>(</rp><rt>うつわ</rt><rp>)</rp></ruby>や宝石の飾りをどっさり持たせて、早速<ruby>西風<rp>(</rp><rt>ゼフイルス</rt><rp>)</rp></ruby>を呼ぶと二人の姉を送り返させるのでした。</p>
<p><sup>９</sup>
こうすぐ送り返されて殊勝な姉達は家に戻りはしたものの、忽ちいや増す<ruby>苦汁<rp>(</rp><rt>せんぶり</rt><rp>)</rp></ruby>のような嫉妬に胸をこがして、種々と二人互いに語りあっては騒ぎ立てるのでしたが、とうとう一人が申しますには、「まあ運の神様は、ほんとうに盲で意地悪で、<ruby>依怙<rp>(</rp><rt>えこ</rt><rp>)</rp></ruby>ひいきだわ、同じ親の娘なものを、気紛れにまるで違った仕合せを受けさせるなんて。
...
そんなにどっさりお<ruby>貨財<rp>(</rp><rt>かね</rt><rp>)</rp></ruby>をもってたって、ちゃんとした使い方も知らないくせにさ。</p>
<p>ねえ、姉様だって見たでしょう、どんなに家中一杯に、何て立派な宝物があったか、何ていう<ruby>綺<rp>(</rp><rt>き</rt><rp>)</rp>羅<rp>(</rp><rt>ら</rt><rp>)</rp></ruby>びやかな生地や、何ていう輝いた宝石や——その上どこもかしこも歩くところはすっかり大へんな黄金だったでしょう。
...
そいでじきに私達のいるのがうるさくなると、風に言いつけてさ、私達を<ruby>追<rp>(</rp><rt>お</rt><rp>)</rp></ruby>ん出させてひゅうっと吹き飛ばさせたことだって。</p>
<p>だからさ、もし私があの人をあんな幸福な<ruby>境<rp>(</rp><rt>きょう</rt><rp>)</rp>涯<rp>(</rp><rt>がい</rt><rp>)</rp></ruby>からひきずり落してやれなかったら、もう女ともいえないし、生きてる値打もありはしないわ。
...
いずれいまには私達は召使じゃあなくて、姉さんだってのが<ruby>解<rp>(</rp><rt>わか</rt><rp>)</rp></ruby>るでしょうよ、そいで今はまあ、ともかくも良人のところへ、貧乏だってもとにかく結構ちゃんとしてる自分の<ruby>家<rp>(</rp><rt>うち</rt><rp>)</rp></ruby>に帰っといて、ゆっくりとあの<ruby>傲慢<rp>(</rp><rt>たかぶり</rt><rp>)</rp></ruby>をこらしめてやる<ruby>手<rp>(</rp><rt>て</rt><rp>)</rp>筈<rp>(</rp><rt>はず</rt><rp>)</rp></ruby>をしっかり工夫しといてから、もっと腹を<ruby>据<rp>(</rp><rt>す</rt><rp>)</rp></ruby>えてまた会うことにしましょう。」</p>
<p><sup>１１</sup>
こんな悪だくみを二人の悪い女は好かろうということに<ruby>定<rp>(</rp><rt>き</rt><rp>)</rp></ruby>めあって、前に貰った立派な<ruby>贈物<rp>(</rp><rt>みやげ</rt><rp>)</rp></ruby>をみんな隠してから、髪をふり乱し、まるで悲歎にくれてでも（まるで悲歎にくれてでも　他の読みでは「それが当然なことであるが」）いるように顔をかきむしって、また<ruby>偽<rp>(</rp><rt>にせ</rt><rp>)</rp></ruby>の涙を出して見せました。
そしていきなり両親をこれもまた湧きかえる悲しみの様子すっかり脅しておいて、正心とも思えぬ考えにふくれて家路を辿るそのひまも、けしからぬ<ruby>奸計<rp>(</rp><rt>わるだくみ</rt><rp>)</rp></ruby>、いや、それどころか<ruby>謀<rp>(</rp><rt>ひと</rt><rp>)</rp>殺<rp>(</rp><rt>ごろし</rt><rp>)</rp></ruby>をさえ、罪もない妹に対して企らむのでした。</p>
<p>その頃プシケに向って、まだ顔もしらぬ良人はいつもの夜半の物語に、またこう言って戒めました。
...
だけれど、度々お前にも言ってあるとおり、一度お前が見たらもうそれからは見られなくなるのだからね。</p>
<p>それだから、もし今度あのこの上なく下等な魔女どもが、よこしまな企らみを胸に装ってやって来ても、——来るのは解っているのだからね——けっして一寸でもロをきいてはならないよ。
...
そしてその子は、お前がこの秘密を黙って守りおおせば、天界のものになろうし、もし破ったら人間にされるのだ。」</p>
<p><sup>１２</sup>
この<ruby>報<rp>(</rp><rt>し</rt><rp>)</rp></ruby>らせを聞いて、プシケは心も<ruby>怡<rp>(</rp><rt>たの</rt><rp>)</rp></ruby>しく<ruby>華<rp>(</rp><rt>はな</rt><rp>)</rp></ruby>やぎ、神様の御子を設ける仕合せに手を<ruby>拍<rp>(</rp><rt>う</rt><rp>)</rp></ruby>ってはしゃぎつつも、またこれから生れてくる愛の証の誉れに気も誇らしく、その母とよばれる嬉しさを有難く思うのでした。
増して行く日の数、過ぎて行く月の数を、心に留めて数えながら、一方また知らない間にいつかこんなに小さな刺されがおなかにこんなに大きな膨らみをさせたのをひどく不思議がっておりました。</p>
<p>けれども、その時にはもうあの<ruby>厄<rp>(</rp><rt>やく</rt><rp>)</rp>病<rp>(</rp><rt>びょう</rt><rp>)</rp>神<rp>(</rp><rt>がみ</rt><rp>)</rp></ruby>たち、ほんとうにいやらしいあの<ruby>復讐鬼<rp>(</rp><rt>フリアエ</rt><rp>)</rp></ruby>どもが、悪蛇の毒気を吐きながら大急ぎで、道ならぬ思いに急き立てられて、船を馳せて来るとこでした。
この時もう一度、<ruby>僅<rp>(</rp><rt>わず</rt><rp>)</rp></ruby>かのひまの訪れに良人は妻のプシケを、繰り返してこう戒めました。</p>
<p>「さあ、最後の日、終局の危機（が迫って来た）。
...
なんという恐ろしい戦さだろう、<ruby>愛<rp>(</rp><rt>いと</rt><rp>)</rp></ruby>しいプシケ、いま私達の上に迫って来てるのはどうかお前や私達を可哀そうだと思って、<ruby>聖<rp>(</rp><rt>とうと</rt><rp>)</rp></ruby>い沈黙を守り、家や良人やお前やその私らの<ruby>嬰児<rp>(</rp><rt>ちいさいの</rt><rp>)</rp></ruby>をさし迫った破滅の非運から救っておくれ、またあの没義道な女達に——もうお前の姉さんとは、こんなに人の破滅を企らむまで憎みつくし、血縁の義理もふみ<ruby>躙<rp>(</rp><rt>にじ</rt><rp>)</rp></ruby>ったからには、呼ばせることは到底できないのだから——会ったり、言うことを聞いたりしないでおくれ、彼奴らがいまに<ruby>魔女<rp>(</rp><rt>シレエン</rt><rp>)</rp></ruby>みたいに<ruby>巖<rp>(</rp><rt>いわお</rt><rp>)</rp></ruby>の上に<ruby>登<rp>(</rp><rt>あが</rt><rp>)</rp></ruby>って来て、<ruby>忌<rp>(</rp><rt>いや</rt><rp>)</rp></ruby>らしい声で岩を<ruby>轟<rp>(</rp><rt>とどろ</rt><rp>)</rp></ruby>かせたってもね。」</p>
<p><sup>１３</sup>
それに答えてプシケは、声も絶えだえに泣きじゃくりながら、</p>
<p>「でもあなた様はもう十分に、私の信実とおしゃべりしないことを確かめて、知ってらっしゃるのではございませんか、今度だっても前の時に負けないくらい、私の心がしっかりしてるのをよくお見せ致しますわ。
...
この<ruby>肉桂<rp>(</rp><rt>キンナモン</rt><rp>)</rp></ruby>の香りのように<ruby>芳<rp>(</rp><rt>かんば</rt><rp>)</rp></ruby>しい、ふさふさと四方に垂れたお<ruby>頭<rp>(</rp><rt>つむ</rt><rp>)</rp></ruby>のお<ruby>髪<rp>(</rp><rt>ぐし</rt><rp>)</rp></ruby>にかけて、この柔かくふっくりとした、私のとそっくりな<ruby>頰<rp>(</rp><rt>ほお</rt><rp>)</rp></ruby>にかけて、このなんともしれぬ熱さに燃えているお胸にかけて、またあなた様のお<ruby>容貌<rp>(</rp><rt>かおだち</rt><rp>)</rp></ruby>をせめてこの<ruby>嬰児<rp>(</rp><rt>やや</rt><rp>)</rp></ruby>のなかに認めることもできようと<ruby>冀<rp>(</rp><rt>こいねが</rt><rp>)</rp></ruby>うほど、切ない心でお<ruby>縋<rp>(</rp><rt>すが</rt><rp>)</rp></ruby>りする私の<ruby>虔<rp>(</rp><rt>つつま</rt><rp>)</rp></ruby>しい願いを<ruby>肯<rp>(</rp><rt>き</rt><rp>)</rp></ruby>き入れて下さって、どうか姉妹たちと抱きあって<ruby>欣<rp>(</rp><rt>よろこ</rt><rp>)</rp></ruby>ぶのをお<ruby>宥<rp>(</rp><rt>ゆる</rt><rp>)</rp></ruby>しになり、あなたに頼りきっているプシケの心を、嬉しさに生き返らせて下さいませ。</p>
<p>もうこれ以上はさらさらに少しもお姿を眼に見たいなどとは思いませんし、今だってもう何も私の邪魔をするものはございませんもの、夜の暗闇でもね。私の光明のあなた様がここにいらっしゃるのですから。」</p>
<p>こうした言葉や優しい<ruby>抱<rp>(</rp><rt>ほう</rt><rp>)</rp>擁<rp>(</rp><rt>よう</rt><rp>)</rp></ruby>にすっかり<ruby>賺<rp>(</rp><rt>すか</rt><rp>)</rp></ruby>されて、良人は妻の涙を自分の<ruby>垂<rp>(</rp><rt>たれ</rt><rp>)</rp>髪<rp>(</rp><rt>がみ</rt><rp>)</rp></ruby>で拭いてやりながら、そうすることを約束し、程もなく明けてゆく日の光にさきがけて、出てまいりました。</p>
<p><sup>１４</sup>
陰謀<ruby>徒党<rp>(</rp><rt>なかま</rt><rp>)</rp></ruby>の例の二人組の姉達は、両親にさえも顔を見せずに、船から上ると真直ぐに例の<ruby>巖<rp>(</rp><rt>いわお</rt><rp>)</rp></ruby>へ、大急ぎでやって来ました、そして自分たちを連れてってくれる風の来るのも待たずに、向う見ずにも自分勝手に谷底へ飛び降りるのでした。
...
それにその子は、当然のことだろうけど、<ruby>両<rp>(</rp><rt>ふた</rt><rp>)</rp>親<rp>(</rp><rt>おや</rt><rp>)</rp></ruby>の<ruby>容色<rp>(</rp><rt>きりよう</rt><rp>)</rp></ruby>に相応すれば、生れたらきっとクピードーそっくりでしょうから。」</p>
<p><sup>１５</sup>
...
それでもほんの一寸でそんな話は打ち切りにして、またどっさりと立派な贈物をもたせ、風の車にのせて二人を送り返しました。</p>
<p><sup>１６</sup>
けれども姉達は、穏やかな<ruby>西風<rp>(</rp><rt>ゼフィルス</rt><rp>)</rp></ruby>の息吹きにのって、高空を家に帰る<ruby>途<rp>(</rp><rt>みち</rt><rp>)</rp>々<rp>(</rp><rt>みち</rt><rp>)</rp></ruby>も、お互いにこう語りあうのでした。
...
でも万一にもあいつが神様の子の——なんてまっ平だけど——母親だって呼ばれるようにでもなったら、私は即座にも<ruby>係蹄<rp>(</rp><rt>かけわな</rt><rp>)</rp></ruby>でもって首をくくってやるわ。だから今のうちに親たちのところへ帰って行って、この<ruby>筋<rp>(</rp><rt>すじ</rt><rp>)</rp>書<rp>(</rp><rt>がき</rt><rp>)</rp></ruby>のはじまりによくあてはまるような虚言をうまくでっちあげて来ましょうよ。」</p>
<p><sup>１７</sup>
こういうわけでかんかんになりながら、二人はろくろく両親に挨拶もせず、夜もおちおち眠らずに過ごしたあげく、<ruby>朝夙<rp>(</rp><rt>はや</rt><rp>)</rp></ruby>くから無茶苦茶になって巖の処へ飛んでゆき、そこから<ruby>例日<rp>(</rp><rt>いつも</rt><rp>)</rp></ruby>のように風におぶさって酷い勢いでとび降り、さて<ruby>眼<rp>(</rp><rt>がん</rt><rp>)</rp>瞼<rp>(</rp><rt>けん</rt><rp>)</rp></ruby>を擦って無理やりに涙を絞り出しといてから、言葉巧みにこうプシケへ持ちかけました。
「まああなたは本当に気楽なのね。
...
それに幾人も、この近処で狩をする人だって、ここらに住んでる<ruby>大<rp>(</rp><rt>たい</rt><rp>)</rp>概<rp>(</rp><rt>がい</rt><rp>)</rp></ruby>の百姓だって、その大蛇がタ方食物あさりから戻ってくるところや、近くの河瀬を遊いでるとこを見てるのですって。</p>
<p><sup>１８</sup>
そいで誰でも言ってますわ、いろいろおいしい御馳走をしてあなたをちやほやしとくのも長いことはあるまいって、そうしてあなたのお腹の子が十分に育ってきたら、一層おいしい<ruby>果実<rp>(</rp><rt>み</rt><rp>)</rp></ruby>のはいったところを、一口に食ってしまうだろうって。だから今よ、しっかり思案を決めるのは。
...
でもまああなたがね、結局こうした田舎で声を相手にひっそり暮し、世間の目を逃れて恋にふけって、汚らわしい生命にもかかわるような<ruby>享薬<rp>(</rp><rt>たのしみ</rt><rp>)</rp></ruby>を、毒蛇相手にやっていくのが嬉しいっていうのだっても、ともかく私達は<ruby>姉妹<rp>(</rp><rt>きょうだい</rt><rp>)</rp></ruby>の情としてするだけの務めはしたわけだから。」</p>
<p>そうするとプシケはあわれにも、単純でやさしい心根から、こんなにも情けない話の恐ろしさに胆を<ruby>呑<rp>(</rp><rt>の</rt><rp>)</rp></ruby>まれてしまい、もののわきまえも見さかいもつかなくなって、途端に良人の戒めも自分のした約束もすっかり<ruby>宙<rp>(</rp><rt>ちゅう</rt><rp>)</rp></ruby>に忘れ果て、底も知れない<ruby>禍<rp>(</rp><rt>わざわ</rt><rp>)</rp></ruby>いの中へと身をつき落すのでした。
体を震わせ、顔は血の気もなくなって<ruby>蒼<rp>(</rp><rt>あお</rt><rp>)</rp></ruby>ざめ、ロごもって聞きとりもしにくいほどの声であえぎながら、しどろもどろに姉達に向って言うには、</p>
<p><sup>１９</sup>
...
さもないと今まで折角私のために色々心配してお尽し頂いたものが、後でかまって下さらないため、駄目になってしまうことになりますわ。」</p>
<p>そこで今はもう、城門もあけ<ruby>開<rp>(</rp><rt>ひろ</rt><rp>)</rp></ruby>げたままの何の<ruby>裸<rp>(</rp><rt>はだか</rt><rp>)</rp></ruby>にしてから、妹の心を虜にしちまった心のねじけた女どもは、今度はもう<a href="#note_machination" title="奸計（攻め道具を隠す小屋）の蔽" id="machination"><ruby>奸計<rp>(</rp><rt>わるだくみ</rt><rp>)</rp></ruby>（攻め道具を隠す小屋）の<ruby>蔽<rp>(</rp><rt>へ</rt><rp>)</rp></ruby></a>いもかなぐりすて、<ruby>詐<rp>(</rp><rt>たばかり</rt><rp>)</rp>謀<rp>(</rp><rt>ごと</rt><rp>)</rp></ruby>の剣を抜き放って、何の<ruby>手<rp>(</rp><rt>て</rt><rp>)</rp>段<rp>(</rp><rt>だて</rt><rp>)</rp></ruby>も<ruby>弁<rp>(</rp><rt>わき</rt><rp>)</rp></ruby>えない<ruby>少女<rp>(</rp><rt>おとめ</rt><rp>)</rp></ruby>のおそれおののく心中へ攻め入って来るのでした。</p>
<p><sup>２０</sup>
とうとう一人が言うことには、「それはもともと私達は血が<ruby>繋<rp>(</rp><rt>つな</rt><rp>)</rp></ruby>がってるんだから、あなたの身の無事安全を計るためには、どんな危難を目の前に見ても、到底たじろいでるわけにはゆきませんわ。
...
勿論私達だってあなたを援けに来ますとも。
で<ruby>其<rp>(</rp><rt>そ</rt><rp>)</rp>奴<rp>(</rp><rt>いつ</rt><rp>)</rp></ruby>が死んであなたがもう大丈夫ということになったら、すぐさまあなたぐるみお宝物も一緒に持ち帰ってさ、それからあなたのお望み次第に、人間だものね、人間のところへお嫁入りさせたげようって今から待ち兼ねてんですわ。」</p>
<p><sup>２１</sup>
こんな文句で、それでなくてもとっくに燃えていた妹の胸をなおせっせと<ruby>煽<rp>(</rp><rt>あお</rt><rp>)</rp></ruby>り立てといてから、自分達はというと、そんな罪深い所業の現場に居合せるのが恐くて仕方なくなったので、いきなり妹を置き去りにし、例のように空をわたる風におし上げられて巖の上に運ばれるが早いか、逃げ足速くすぐさま船に乗って帰って行くのでした。</p>
<p>さてプシケはただ一人取り残されて——<ruby>尤<rp>(</rp><rt>ゆう</rt><rp>)</rp></ruby>も恐ろしい<ruby>復讐女神<rp>(</rp><rt>フリアエ</rt><rp>)</rp></ruby>たちがくっついて心を<ruby>攪<rp>(</rp><rt>か</rt><rp>)</rp></ruby>き乱してるのでは、一人でもないわけながら——湧き立つ海の波のようただ涙にくれて迷いたゆとう有様に、心はこうと思い<ruby>定<rp>(</rp><rt>き</rt><rp>)</rp></ruby>めしっかり<ruby>臍<rp>(</rp><rt>ほぞ</rt><rp>)</rp></ruby>は固めていてきて実際仕事に手を下す、また考えがぐらついてたじたじとなり、身にふり掛った<ruby>災難<rp>(</rp><rt>わざわい</rt><rp>)</rp></ruby>をさまざまに繰り返しては思い煩うのでした。
...
夜がくると良人もゃって来て、ひとしきり<ruby>美神<rp>(</rp><rt>ヴエヌス</rt><rp>)</rp></ruby>の<ruby>前<rp>(</rp><rt>さき</rt><rp>)</rp>哨<rp>(</rp><rt>がけ</rt><rp>)</rp>戦<rp>(</rp><rt>いくさ</rt><rp>)</rp></ruby>がとりかわされるほどもなく、深い眠りに落ちてまいました。</p>
<p><sup>２２</sup>
するとプシケは、平生は<ruby>身体<rp>(</rp><rt>からだ</rt><rp>)</rp></ruby>も心もかよわい身ながら、残酷な運命に<ruby>駆<rp>(</rp><rt>か</rt><rp>)</rp></ruby>り立てられて今は<ruby>確固<rp>(</rp><rt>しっかり</rt><rp>)</rp></ruby>した力が加わったものか、燭治をとり出し<ruby>剃<rp>(</rp><rt>かみ</rt><rp>)</rp>刀<rp>(</rp><rt>そり</rt><rp>)</rp></ruby>を手に握った大胆のさまは、女とも見えない変りようです。
...
その景色を見ては燭台の明りさえもはしゃいで光を添え、剃刀も大それたことを<ruby>企<rp>(</rp><rt>たく</rt><rp>)</rp></ruby>んだ刃の光を悔むように見えました。</p>
<p>けれどもプシケは思いがけぬこの有様に胆を<ruby>消<rp>(</rp><rt>けや</rt><rp>)</rp></ruby>して正体もなく、気も絶えだえに<ruby>色蒼<rp>(</rp><rt>いろあお</rt><rp>)</rp></ruby>ざめて<ruby>慄<rp>(</rp><rt>ふる</rt><rp>)</rp></ruby>えながらに<ruby>膝<rp>(</rp><rt>ひざ</rt><rp>)</rp></ruby>の上にくずおれてしまい、はては<ruby>刃<rp>(</rp><rt>え</rt><rp>)</rp>物<rp>(</rp><rt>もの</rt><rp>)</rp></ruby>をとってあるまいことか自分の胸のなか深く突きこもうとまでするのでした。
...
もう疲れきって、やっと助かった思いにぐったりとしながら、プシケは神々しいその顔だちの美しさに<ruby>飽<rp>(</rp><rt>あ</rt><rp>)</rp></ruby>かず眺め入っては、ほっと息を<ruby>吐<rp>(</rp><rt>つ</rt><rp>)</rp></ruby>くばかりです。</p>
<p>金色の<ruby>頭<rp>(</rp><rt>つむり</rt><rp>)</rp></ruby>には心地よげな髪の毛が、<ruby>噎<rp>(</rp><rt>む</rt><rp>)</rp></ruby>せ返るほど<ruby>仙香<rp>(</rp><rt>アンプロシア</rt><rp>)</rp></ruby>に<ruby>薫<rp>(</rp><rt>かお</rt><rp>)</rp></ruby>っています。
...
寝台の脚先には弓矢と<ruby>箙<rp>(</rp><rt>えびら</rt><rp>)</rp></ruby>と、この大神様の有難い物の具がおいてあります。</p>
<p><sup>２３</sup>
それを飽くことを知らない熱心さで、プシケは好奇心に<ruby>駆<rp>(</rp><rt>か</rt><rp>)</rp></ruby>り立てられるまま、ためつすがめつながめては、自分の良人の<ruby>武具<rp>(</rp><rt>もののぐ</rt><rp>)</rp></ruby>に感入しているうち、ふと<ruby>箙<rp>(</rp><rt>えびら</rt><rp>)</rp></ruby>から一本の矢を取り出して、親指の先で<ruby>鏃<rp>(</rp><rt>やじり</rt><rp>)</rp></ruby>の鋭さを<ruby>吟<rp>(</rp><rt>ぎん</rt><rp>)</rp>味<rp>(</rp><rt>み</rt><rp>)</rp></ruby>してみました。
...
こうなると層一層と<ruby>愛神<rp>(</rp><rt>クピードー</rt><rp>)</rp></ruby>のこいしさが身に<ruby>沁<rp>(</rp><rt>しみ</rt><rp>)</rp></ruby>り渡り、はては無我夢中でのしかかるようにその<ruby>貌<rp>(</rp><rt>かお</rt><rp>)</rp></ruby>を飽かず眺め入って、心の<ruby>急<rp>(</rp><rt>せ</rt><rp>)</rp></ruby>くままやたらに<ruby>接吻<rp>(</rp><rt>くちづけ</rt><rp>)</rp></ruby>を繰り返しては、ただ眠りの頃あいだけに気を遣うのでした。</p>
<p>ところが、あまりの嬉しさに心も添わず胸の痛手になやみ迷うそのひまに、先程の<ruby>灯<rp>(</rp><rt>とう</rt><rp>)</rp>明<rp>(</rp><rt>みょう</rt><rp>)</rp></ruby>が、憎たらしい裏切りからかまたは<ruby>忌<rp>(</rp><rt>いま</rt><rp>)</rp></ruby>わしい<ruby>嫉<rp>(</rp><rt></rt><rp>)</rp>妬<rp>(</rp><rt>ねたみ</rt><rp>)</rp></ruby>心からか、それともこんなにも優しい<ruby>姿態<rp>(</rp><rt>おすがた</rt><rp>)</rp></ruby>に自分でも手を触れて、同じょうに<ruby>接吻<rp>(</rp><rt>くちづけ</rt><rp>)</rp></ruby>をしてみたいとでも思ったのか、燃えている<ruby>芯<rp>(</rp><rt>しん</rt><rp>)</rp></ruby>のさきから熱い油をひとたらし、その神様の右の肩へと落したのです。
...
そもそもその由来因縁そのものが、誰かある恋人が夜の<ruby>間<rp>(</rp><rt>ま</rt><rp>)</rp></ruby>ももっとゆっくり楽しみながら過ごしたいとでも思って、発明したにちがいないのに。</p>
<p>こういうわけで体を焼かれて、約束の秘密がこのように破られて滅茶苦茶になったのを覚ると、<ruby>神様<rp>(</rp><rt>グピードー</rt><rp>)</rp></ruby>はいきなり不仕合せな妻の<ruby>接吻<rp>(</rp><rt>くちづけ</rt><rp>)</rp></ruby>や抱擁から<ruby>脱<rp>(</rp><rt>ぬ</rt><rp>)</rp></ruby>け出て、ものも言わずに飛び去って行くのでした。</p>
<p><sup>２４</sup>
それでもすぐとプシケは、立ってゆく良人の右の<ruby>腓脛<rp>(</rp><rt>ふくらはぎ</rt><rp>)</rp></ruby>に両手で取り<ruby>縋<rp>(</rp><rt>すが</rt><rp>)</rp></ruby>り、空高い神の<ruby>飛<rp>(</rp><rt>ひ</rt><rp>)</rp>行<rp>(</rp><rt>ぎょう</rt><rp>)</rp></ruby>のあわれにいじらしい<ruby>附<rp>(</rp><rt>つき</rt><rp>)</rp>物<rp>(</rp><rt>もの</rt><rp>)</rp></ruby>といった形で、雲界を突き抜けてゆく折も垂れ下ったまま、今を極みと共々に<ruby>随<rp>(</rp><rt>つ</rt><rp>)</rp></ruby>いてゆくのでしたが、とうとう疲れ果てて地面へ<ruby>墜<rp>(</rp><rt>おつこ</rt><rp>)</rp></ruby>ちてしまいました。</p>
<p>しかし、いとしく思う神様は地上に<ruby>臥<rp>(</rp><rt>ふ</rt><rp>)</rp></ruby>している<ruby>少女<rp>(</rp><rt>おとめ</rt><rp>)</rp></ruby>を捨てておいでにならず、すぐ傍らにある<ruby>糸<rp>(</rp><rt>いと</rt><rp>)</rp>杉<rp>(</rp><rt>すぎ</rt><rp>)</rp></ruby>の上に降りて、その高い<ruby>天頂<rp>(</rp><rt>てっぺん</rt><rp>)</rp></ruby>から大変に腹立ちのロ調で、こう言いかけなりました。<br />
...
こう言い終ると翼にのって空高く翔けりってゆきました。</p>
<p><sup>２５</sup>
プシケは地面に倒れ伏しつつも、なおまだ眼の届くかぎりは良人の飛ぶさまを追い眺めて、ただ、劇しく泣き悲しみながら心を痛めておりましたが、とうとう翼を<ruby>櫂<rp>(</rp><rt>かい</rt><rp>)</rp></ruby>に良人の姿が久方の空はるかに消えて見えなくなりますと、すぐ近くの流れの岸から真逆さまに身を投げました。
けれども、優しい川は、きっとこの水さえもいつも燃えたたせてしまう神様に義理を立ててのことでしょう、巻添えを恐れて早速少女を渦巻にのせ、そっと怪我をしないように、草花の咲き乱れた河岸へ置くのでした。</p>
<p>ちょうどそのときはからずも野山の神様のパーンが河流の<ruby>眉<rp>(</rp><rt>まゆ</rt><rp>)</rp></ruby>わに近く座を占めて、<a href="#note_echo" title="山ずみの女神" id="echo">山ずみの女神</a><ruby>谺<rp>(</rp><rt>こだま</rt><rp>)</rp></ruby>（エコー）を<ruby>傍<rp>(</rp><rt>わき</rt><rp>)</rp></ruby>へ引きつけながら、種々さまざまな声音を歌いかえすことを教えていました。
川岸のすぐそばには山羊たちが放し飼いになって、流れの髪の毛を刈り取っては遊び戯れています。
山羊の足をした神様は、心を傷め気も絶えだえのプシケを傍へ親切に呼び寄せ、いろんなわけからその悲しい話もとうに知っていましたので、やさしい言葉でこう乙女を慰めるのでした。</p>
<p>「きれいな娘さんは全く田舎者の羊飼だが、年をとるのも長くなったお陰でもって、いろんな目にもあい物の<ruby>鑑識<rp>(</rp><rt>みわけ</rt><rp>)</rp></ruby>もつくような次第だけれど、もし私の推量に狂いがなければ——それを賢い人達がとりも直さず占いというのだろうが——お前さんの<ruby>躊躇<rp>(</rp><rt>ためら</rt><rp>)</rp></ruby>いがちなよろよろした歩き方だの、ひどく<ruby>蒼<rp>(</rp><rt>あお</rt><rp>)</rp></ruby>ざめた肌の色や始終溜息がちなことや、いや何より第一お前さんのその悲しそうな眼つきから見ても、これはお前さんは恋のあまりに責められていなさるのだ。それゆえ私のいうことをよく聴いて、もう身を投げたりそのほか自分から好んで死ぬような<ruby>真<rp>(</rp><rt>ま</rt><rp>)</rp>似<rp>(</rp><rt>ね</rt><rp>)</rp></ruby>は、またとなさらぬがよい。
歎いたり悲しんだりするのも止めて、それよりも神様の中でも一番偉い<ruby>愛の神<rp>(</rp><rt>クピードー</rt><rp>)</rp></ruby>に、よくお祈りして願いなさい、でお気に入るよう誠を尽して御神意に叶うがいいだろう。あの方もまだ年若で気の優しい遊び好きな神様だから。」</p>
<p><sup>２６</sup>
こう論してくれた牧の神様にも何の言葉も返さず、ただ自分の身を<ruby>庇<rp>(</rp><rt>かば</rt><rp>)</rp></ruby>い<ruby>護<rp>(</rp><rt>まも</rt><rp>)</rp></ruby>って下さる御心に手を合せたばかりで、プシケはまた歩み去って行くのでした。
...
切岩の上を落ちてゆくうちに手も肢もばらばらになって、あとでは心<ruby>相<rp>(</rp><rt>そう</rt><rp>)</rp>応<rp>(</rp><rt>おう</rt><rp>)</rp></ruby>に鳥や獣に<ruby>臓<rp>(</rp><rt>ぞう</rt><rp>)</rp>腑<rp>(</rp><rt>ふ</rt><rp>)</rp></ruby>を裂き<ruby>啄<rp>(</rp><rt>ついば</rt><rp>)</rp></ruby>まれ、<ruby>恰好<rp>(</rp><rt>かっこう</rt><rp>)</rp></ruby>の餌食となるのがその最期でした。</p>
<p>またその次の<ruby>応報<rp>(</rp><rt>しかえし</rt><rp>)</rp></ruby>の<ruby>処罰<rp>(</rp><rt>おしおき</rt><rp>)</rp></ruby>も長くはかからなかった、というのは、またもプシケがぶらぶらと歩いてゆくうちに、他の町へつきますと、そこには同じような<ruby>工<rp>(</rp><rt>ぐ</rt><rp>)</rp>合<rp>(</rp><rt>あい</rt><rp>)</rp></ruby>で、もう一人の姉が住んでいたのです。
そしてこの女も前とことならず、妹のつくりごとに釣られて、悪性にも妹の嫁入り口を横奪りしようと巖のところへ急いで行き、同じような<ruby>死態<rp>(</rp><rt>しにざま</rt><rp>)</rp></ruby>を遂げたのでした。</p>
<p><sup>２８</sup>
一方プシケがしきりと<ruby>愛の神<rp>(</rp><rt>クビードー</rt><rp>)</rp></ruby>を尋ねて国々を巡歴している間に、彼方では<ruby>燭<rp>(</rp><rt>ともし</rt><rp>)</rp>火<rp>(</rp><rt>び</rt><rp>)</rp></ruby>の傷の痛さにお母様の奥の間に<ruby>臥<rp>(</rp><rt>こや</rt><rp>)</rp></ruby>ったまま<ruby>呻<rp>(</rp><rt>しん</rt><rp>)</rp>吟<rp>(</rp><rt>ぎん</rt><rp>)</rp></ruby>していました。
...
<p>そこでヴェヌスはすっかり腹を立てて、急に叫び立てました。<br />
...
ニンフ達の一人かそれとも季節の<ruby>精<rp>(</rp><rt>ホラ</rt><rp>)</rp></ruby>たちか、<ruby>薬女<rp>(</rp><rt>ムウサ</rt><rp>)</rp></ruby>の<ruby>歌舞団<rp>(</rp><rt>コロス</rt><rp>)</rp></ruby>のなかまか、またはお<ruby>扈<rp>(</rp><rt>こ</rt><rp>)</rp>従<rp>(</rp><rt>じゅう</rt><rp>)</rp></ruby>の美の<ruby>精<rp>(</rp><rt>グラテイア</rt><rp>)</rp></ruby>たちのうちの女かえ。」</p>
<p>するとそのお喋り鳥が黙ってればいいものを、<br />
...
もともと私があいつを{r}紹介{/r(ひきあわ)}せてやったんだからね。」</p>
<p><sup>２９</sup>
こう大声に言い立てながら大急ぎで海を出て、すぐさま自分の金色のお居間へ行って、話のとおりに息子が病気で臥ているのを見つけますと、もういきなりその扉ロのところから声を限りに叫び立てるのでした。<br />
...
それに何一つお前のお父様の<ruby>財産<rp>(</rp><rt>もちもの</rt><rp>)</rp></ruby>から、その<ruby>身<rp>(</rp><rt>み</rt><rp>)</rp>拵<rp>(</rp><rt>ごしら</rt><rp>)</rp></ruby>えにって貰ったものはないのじゃないか。</p>
<p><sup>３０</sup>
本当に赤ん坊の時から<ruby>躾<rp>(</rp><rt>しつ</rt><rp>)</rp></ruby>けが悪くて、その上に手が速くって、目上の人たちを何度かもしれないほど見さかいなしに酷い目にあわせといて、その上自分の母親までをさ、私をだよ、この<ruby>極<rp>(</rp><rt>ごく</rt><rp>)</rp>道<rp>(</rp><rt>どう</rt><rp>)</rp></ruby>者が、しょっちゅういい<ruby>曝<rp>(</rp><rt>さら</rt><rp>)</rp></ruby>し者にしてさ、何度も何度も矢を射かけて、それにほんの<ruby>寡婦<rp>(</rp><rt>やもの</rt><rp>)</rp></ruby>と思ってだろう、馬鹿にしてばっかり、<a href="#note_mars" title="義理のお父様でも" id="mars">義理のお父様でも</a>、　あんなとてもお強い偉い<ruby>武士<rp>(</rp><rt>おさむらい</rt><rp>)</rp></ruby>なのに、ちっとも怖がりもしないのだよ。
...
私がこの自分の手でもって金色の輝きに染め上げてやった髪やこの<ruby>懐<rp>(</rp><rt>ふとこ</rt><rp>)</rp></ruby>ろで<ruby>仙酒<rp>(</rp><rt>ネクタル</rt><rp>)</rp></ruby>の泉に浸してやった翼なんかをね。」</p>
<p><sup>３１</sup>
こう言い放つと荒々しくヴェヌス一流の<ruby>激怒<rp>(</rp><rt>ヒステリー</rt><rp>)</rp></ruby>に<ruby>猛<rp>(</rp><rt>たけ</rt><rp>)</rp></ruby>り立ちながら家の外へ出てゆきました。
...
あなた方だって勿論私のところの結構な評判も、お話にもならないあの息子の<ruby>所<rp>(</rp><rt>し</rt><rp>)</rp>業<rp>(</rp><rt>わざ</rt><rp>)</rp></ruby>も、よく知ってらっしゃるのでしょうからね。」</p>
<p>そうすると二人の女神たちは、その<ruby>顚<rp>(</rp><rt>てん</rt><rp>)</rp>末<rp>(</rp><rt>まつ</rt><rp>)</rp></ruby>はよく心得ていましたけれど、ヴェヌスのきつい腹立ちを<ruby>宥<rp>(</rp><rt>なだ</rt><rp>)</rp></ruby>めようとして、こう言いました。<br />
...
だけど、あなたが自分の家では<ruby>色恋沙汰<rp>(</rp><rt>いろこい</rt><rp>)</rp></ruby>をそれこそ厳重にせき止めといて、女ごころの気よわさの<ruby>諸人<rp>(</rp><rt>みんな</rt><rp>)</rp></ruby>に許された<ruby>娯楽<rp>(</rp><rt>たのしみ</rt><rp>)</rp></ruby>場にも入れさせないなら、神様だって人間だって、誰一人としてあんたがやたらに世間中へ<ruby>愛情<rp>(</rp><rt>なさけ</rt><rp>)</rp></ruby>の種子をまいてあるくのを放っとくものですか。」</p>
<p>こう女神たちは、本人はそこにいないながら、矢の勢いを畏れて、<ruby>愛の神<rp>(</rp><rt>クビードー</rt><rp>)</rp></ruby>に都合のいい弁護をしてやって機嫌をとるのでしたが、ヴェヌスの方は、ひどい目にあったのをこう<ruby>弄<rp>(</rp><rt>いろ</rt><rp>)</rp></ruby>みものにされてしまったので腹を立て、二人を向うへやりすごしておいてから、足もせわしくまた来た道を海原の方へと向ってまいりました。</p>
<p>巻の六</p>
<p><sup>１</sup>
話変ってプシケはあちらこちらと<ruby>駆け回<rp>(</rp><rt>めぐ</rt><rp>)</rp></ruby>っては、夜も昼も良人を探し尋ねて心の<ruby>憩<rp>(</rp><rt>やす</rt><rp>)</rp></ruby>むひまもなく、ただひたすらにその<ruby>憤<rp>(</rp><rt>いきど</rt><rp>)</rp></ruby>りを、よし妻としての優しい言葉で<ruby>宥<rp>(</rp><rt>なだ</rt><rp>)</rp></ruby>めることはもうかなわぬにしても、せめて<ruby>婢<rp>(</rp><rt>はたしめ</rt><rp>)</rp></ruby>の祈願でもって和らげたいものといやましに願い求めるのでした。
...
それをプシケはいちいち丁寧にわけて、ちゃんとそれぞれ片づけて<ruby>蔵<rp>(</rp><rt>しま</rt><rp>)</rp></ruby>いました、というのは、どんなお神殿にしろ自分は<ruby>等閑<rp>(</rp><rt>なおざり</rt><rp>)</rp></ruby>にしないで、すべての神様の慈悲をねがい求めなければならないと考えたからです。</p>
<p><sup>２</sup>
ちょうどこうやって心をこめてせっせとお手伝いをしてるところへ情け深いケレースがおいでになり、少女をお認めになると、すぐさま大きな声で呼びかけました。<br />
「まあ、お前は可哀そうなプシケじゃないの。
...
それなのにお前は私のうちの仕事の世話をしてくれて、自分の身の無事安全にも<ruby>関係<rp>(</rp><rt>かかわり</rt><rp>)</rp></ruby>のないことを考えているのだわねえ。」</p>
<p>そこでプシケはその<ruby>足<rp>(</rp><rt>あし</rt><rp>)</rp>許<rp>(</rp><rt>もと</rt><rp>)</rp></ruby>に身を投げ伏して、<ruby>饒<rp>(</rp><rt>ゆた</rt><rp>)</rp></ruby>かな涙で女神のおみあしを潤おし、大地を自分の髪の毛で拭き払いながら、いろいろと祈願をこめてひたすらお助けをお願いするのでした。
...
どうかあの尊い高い女神さまのはげしいお憤りが、時のたつにつれ和らいでまいりますまで、いえそれまでならずとも、せめて長い<ruby>艱<rp>(</rp><rt>かん</rt><rp>)</rp>難<rp>(</rp><rt>なん</rt><rp>)</rp></ruby>につきはてた私の力が、<ruby>暫<rp>(</rp><rt>しばら</rt><rp>)</rp></ruby>くでも休まって落ちつくまでなり、そこにある穂の積み重ねの中に、二三日の間でも身をかくさせて下さいませ。」</p>
<p><sup>３</sup>
それに応えてケレースがいうには、<br />
...
そんなわけだからすぐとこの家から出ていっとくれ、そいで私が<ruby>捕<rp>(</rp><rt>つか</rt><rp>)</rp></ruby>まえて<ruby>因人<rp>(</rp><rt>めしうど</rt><rp>)</rp></ruby>にしなかったのを<ruby>精<rp>(</rp><rt>せい</rt><rp>)</rp>々<rp>(</rp><rt>ぜい</rt><rp>)</rp></ruby>いいことと考えておくれよ。」</p>
<p>プシケは自分の思いがけとすっかり反対に、追い出しを食って（いまは）二重の悲しみに打ち<ruby>挫<rp>(</rp><rt>ひし</rt><rp>)</rp></ruby>がれ、とぼとまたもとの道をひろって参りますうち、低まの<ruby>谿<rp>(</rp><rt>たに</rt><rp>)</rp></ruby>の<ruby>小<rp>(</rp><rt>お</rt><rp>)</rp>昏<rp>(</rp><rt>ぐら</rt><rp>)</rp></ruby>い木立のあいだに、<ruby>工<rp>(</rp><rt>こう</rt><rp>)</rp>匠<rp>(</rp><rt>しょう</rt><rp>)</rp></ruby>の腕をつくしたお社があるのを見つけました。
...
それにまた法律でもねえ、<ruby>他家<rp>(</rp><rt>よそ</rt><rp>)</rp></ruby>の<ruby>下婢<rp>(</rp><rt>はしため</rt><rp>)</rp></ruby>が逃げたのを主人の同意なしに受け入れてはならないことになってるので、駄目なのだからねえ。」</p>
<p><sup>５</sup>
今度もまたかように、仕合せの船が難破してしまったことは、もう羽根の生えた良人を探し求める力も出ないほどプシケを<ruby>怖<rp>(</rp><rt>おじ</rt><rp>)</rp>気<rp>(</rp><rt>け</rt><rp>)</rp></ruby>づかせ、今はもう身の助かる<ruby>術<rp>(</rp><rt>すべ</rt><rp>)</rp></ruby>も望みも失せ果てて、こうひとり思案に沈むのでした。<br />
...
こうして末の成行きも疑わしい服従、いえそれどころかほとんどわが身の破滅をさえ心に覚悟しながら、プシケはこれからさきどうお<ruby>懇願<rp>(</rp><rt>ねがい</rt><rp>)</rp></ruby>をはじめたらよいかと思案するのでした。</p>
<p><sup>６</sup>
一方ヴェヌスは地上を<ruby>索<rp>(</rp><rt>さが</rt><rp>)</rp></ruby>しまわっても仕方がないとあきらめて、天へ向って出かけました。
...
その御輦を取り巻いて声々に<ruby>囀<rp>(</rp><rt>さえず</rt><rp>)</rp></ruby>りあそぶのは<ruby>雀<rp>(</rp><rt>すずめ</rt><rp>)</rp></ruby>やその他いろいろな好い歌声の鳥たちで、調べも妙に節おもしろく歌い立てながら、女神様の御入来を（ルクレーティウスの冒頭より来た叙述ならん）<ruby>天<rp>(</rp><rt>あめ</rt><rp>)</rp>地<rp>(</rp><rt>つち</rt><rp>)</rp></ruby>に告げ知らせるのでした。</p>
<p>と雲は割れて引き退り、天は御娘のためにずっとうち開けて、<ruby>遙<rp>(</rp><rt>はる</rt><rp>)</rp></ruby>かな高ぞらは<ruby>喜悦<rp>(</rp><rt>よろこび</rt><rp>)</rp></ruby>にあふれて女神を迎えます。
<ruby>途<rp>(</rp><rt>みち</rt><rp>)</rp></ruby>に遇う<ruby>鷲<rp>(</rp><rt>わし</rt><rp>)</rp></ruby>も<ruby>貪慾<rp>(</rp><rt>どんよく</rt><rp>)</rp></ruby>な<ruby>鷹<rp>(</rp><rt>たか</rt><rp>)</rp></ruby>も、広大なヴェヌスの<ruby>朗<rp>(</rp><rt>ほが</rt><rp>)</rp></ruby>らかな<ruby>眷<rp>(</rp><rt>けん</rt><rp>)</rp>族<rp>(</rp><rt>ぞく</rt><rp>)</rp></ruby>たちにはちっとも怖くありません。</p>
<p><sup>７</sup>
女神はそれからまっすぐとユッピテルの大宮<ruby>敷<rp>(</rp><rt>しき</rt><rp>)</rp></ruby>におみあしを向けて、意気高々と、あの声の大きな神様の<a href="#note_mercurius" title="メルクリウス" id="mercurius">メルクリウス</a>を是非とも手助けに貸して頂きたいとお願いになりました。
...
こう言いながらメルクリウスの眼の前にプシケの名だのその他いろんなことが記してある<ruby>貼子<rp>(</rp><rt>びら</rt><rp>)</rp></ruby>を差し出し、話がつくとすぐさまお宅へお帰りになりました。</p>
<p><sup>８</sup>
...
通告の褒美としてその者にはヴェヌスさま御ロずから七つの快いロづけと、もう一つそれはそれは<ruby>甘<rp>(</rp><rt>おいし</rt><rp>)</rp></ruby>いのを、心もとろけるお舌押しでなし下される。」</p>
<p>こんな風にメルクリウスが言って歩くと、その素晴しい褒美をせしめたさの一心が、ありとあらゆる人間どもをお互いにせり合い競い合せるという有様で、この<ruby>顚<rp>(</rp><rt>てん</rt><rp>)</rp>末<rp>(</rp><rt>まつ</rt><rp>)</rp></ruby>こそ何よりも一とうプシケの胸から、これ以上ほんの一寸でも<ruby>躊躇<rp>(</rp><rt>しりごみ</rt><rp>)</rp></ruby>しようという気持をなくさせてしまった理由でした。
...
でもこれでいいのよ、誰というより私の手にとっ捕まったからには、もう地獄の<ruby>距<rp>(</rp><rt>はずめ</rt><rp>)</rp></ruby>にひっ摑まえたも同然、これから早速今までの増長慢のこらしめをうんとみせてやってくれるからね」</p>
<p><sup>９</sup>
こういうと乱暴にもプシケの髪の毛に手を突き込んで、何の<ruby>抵抗<rp>(</rp><rt>てむかい</rt><rp>)</rp></ruby>もしないでるのを引きずって行き、ヴェヌスの<ruby>御<rp>(</rp><rt>ご</rt><rp>)</rp>殿<rp>(</rp><rt>てん</rt><rp>)</rp></ruby>につれ込んで御前へと引っ立てて参りました。
...
またそいだから万が一子を産むのを見逃しとくにしても、生まれた子供は私生児ということになるのだよ。」</p>
<p><sup>１０</sup>
こう言い終るとプシケにとびかかって、<ruby>著<rp>(</rp><rt>き</rt><rp>)</rp>物<rp>(</rp><rt>もの</rt><rp>)</rp></ruby>をびりびりに引き裂き、髪をふりほごし、頭をゆすぶったりして、さんざんに<ruby>打<rp>(</rp><rt>ちょう</rt><rp>)</rp>擲<rp>(</rp><rt>ちゃく</rt><rp>)</rp></ruby>したあげく、小麦や大麦や、栗に<ruby>罌<rp>(</rp><rt>け</rt><rp>)</rp>栗<rp>(</rp><rt>し</rt><rp>)</rp>粒<rp>(</rp><rt>つぶ</rt><rp>)</rp></ruby>、<ruby>小豆<rp>(</rp><rt>あずき</rt><rp>)</rp></ruby>、<ruby>豌<rp>(</rp><rt>えん</rt><rp>)</rp>豆<rp>(</rp><rt>どう</rt><rp>)</rp></ruby>、<ruby>蚕<rp>(</rp><rt>そら</rt><rp>)</rp>豆<rp>(</rp><rt>まめ</rt><rp>)</rp></ruby>などを取り寄せ、ごちゃごちゃにかきまわし一山に混ぜ合せて積んでおいて、こう言いつけるのでした。<br />
...
そこにまぜて置いてあるいろんな種子の寄せあつめを選り分けておくれ、一粒ずっちゃんと種類別にしておいてね、この夕方までに得心がいくようしっかりと片をつけとくのだよ。」</p>
<p>こんな風に山のような<ruby>雑穀<rp>(</rp><rt>ざっこく</rt><rp>)</rp></ruby>の積み重ねをおしつけといて、自分は御婚礼の<ruby>饗宴<rp>(</rp><rt>もてなし</rt><rp>)</rp></ruby>に出かけてしまいましたが、プシケはその乱雑な手のつけようもない（穀類の）山に手を出そうともせず、ただ茫然と言いつけられた仕事の大きさにたまげ、物もいわずに呆れているばかりでした。
...
するとどんどん一団また一団と六足<ruby>勢<rp>(</rp><rt>ぜい</rt><rp>)</rp></ruby>の波は次々におしかけて来ます、そして一生懸命になってめいめいが一粒ずつ山と積んだ穀物をすっかり始末し、それぞれ別に種類分けにいたしますと、さっさと姿を消してしまいました。</p>
<p><sup>１１</sup>
夜がくると婚礼の宴からヴェヌスが帰ってまいりました、お酒を十分にきこしめし、<ruby>安息香<rp>(</rp><rt>バルサモ</rt><rp>)</rp></ruby>を<ruby>頻<rp>(</rp><rt>しき</rt><rp>)</rp></ruby>りと<ruby>匂<rp>(</rp><rt>にお</rt><rp>)</rp></ruby>わせ、体じゅうには照り咲いた薔薇の花を巻きつけております、言いつけた仕事がびっくりするほど立派に<ruby>士尽<rp>(</rp><rt>しおお</rt><rp>)</rp></ruby>されてるのを見ますと、<br />
...
こんな次第で同じ屋根の下ながらこの好いた同士は引き離されて別々に、みじめな夜を明かしたのでした。</p>
<p>しかし<a href="#note_aurora" title="払暁がほんのいま馬車" id="aurora"><ruby>払暁<rp>(</rp><rt>あけがた</rt><rp>)</rp></ruby>がほんのいま<ruby>馬車<rp>(</rp><rt>くるま</rt><rp>)</rp></ruby></a>を空に乗りだすとヴェヌスはプシケを呼びよせてこう言いつけました。<br />
...
その立派な羊の毛皮から毛を<ruby>一<rp>(</rp><rt>ひと</rt><rp>)</rp>房<rp>(</rp><rt>ふさ</rt><rp>)</rp></ruby>どうにでもして大至急私にとって来て欲しいのだがねえ。」</p>
<p><sup>１２</sup>
プシケは<ruby>唯<rp>(</rp><rt>ただ</rt><rp>)</rp>々<rp>(</rp><rt>ただ</rt><rp>)</rp></ruby>とすすんで出かけてまいりました。
...
そいで乱暴が<ruby>和<rp>(</rp><rt>な</rt><rp>)</rp></ruby>いで羊どもの張りつめた気も<ruby>弛<rp>(</rp><rt>たる</rt><rp>)</rp></ruby>んできたら、早速すぐわきの木立の<ruby>枝<rp>(</rp><rt>えだ</rt><rp>)</rp>葉<rp>(</rp><rt>は</rt><rp>)</rp></ruby>をゆすぶれば、金色の羊の毛が見つかるでしょう、その<ruby>彎<rp>(</rp><rt>まが</rt><rp>)</rp></ruby>った幹の方々にくっついておりますから。」</p>
<p><sup>１３</sup>
...
こういうと水晶を<ruby>刻<rp>(</rp><rt>ほ</rt><rp>)</rp></ruby>りぬいた<ruby>容<rp>(</rp><rt>いれ</rt><rp>)</rp>器<rp>(</rp><rt>もの</rt><rp>)</rp></ruby>を、その上にももっと重い仕置きで脅しながらプシケに手渡しました。</p>
<p><sup>１４</sup>
そこで少女は次はせっせと足の運びも速やかに、山の一番上の高みへと向って参りました、今度こそその処でこの上もなく惨めな自分の命に<ruby>決著<rp>(</rp><rt>けっちゃく</rt><rp>)</rp></ruby>をつけられようと思ってです。
...
右にも左の方にも<ruby>洞<rp>(</rp><rt>うろ</rt><rp>)</rp></ruby>になった切岩からは恐ろしい竜が這い出し……長い頸をもち上げ、その<ruby>眼<rp>(</rp><rt>まなこ</rt><rp>)</rp></ruby>はまばたきもせずにしっかりと見張りをつづけ、たえず日光をみつめるその瞳には少しの間のたゆみさえありません。</p>
<p>しかもその上にその水までが声をたてて自分自身を<ruby>禦<rp>(</rp><rt>ふせ</rt><rp>)</rp></ruby>ぎ守り、「あっちへ行け」とか「何をする、よく見ろ」とか「何をやるのだ、気をつけろ」とか「逃げろ」とか、それからまた「そら死ぬぞ」などと呼び立てるのです。
この有様を見るプシケは仕事などとても思いもよらず、自身が石にでも<ruby>化<rp>(</rp><rt>な</rt><rp>)</rp></ruby>ってしまったかのように、体はそこにあっても眼や耳の感覚はぼうっと脱けてなくなり、抜きさしもならぬこの難業の重荷にすっかり圧倒されてしまって、最後の慰めという涙さえも出ない始末でした。</p>
<p><sup>１５</sup>
...
こんな次第で、一杯になった<ruby>甕<rp>(</rp><rt>かめ</rt><rp>)</rp></ruby>を大喜びでプシケは受け取り、急いでヴェヌスのところへと持って参りました。</p>
<p><sup>１６</sup> それでもまだこんなにしてさえも猛り立つ女神の<ruby>御<rp>(</rp><rt>み</rt><rp>)</rp>意<rp>(</rp><rt>こころ</rt><rp>)</rp></ruby>を和げることはかないません。
...
でもぐずぐずしないでさっさと帰って来るのだよ。私は是が非でもそれをつけて、神様たちの<ruby>観劇<rp>(</rp><rt>おしばい</rt><rp>)</rp></ruby>に出かけなけりゃならないのだからね。」</p>
<p><sup>１７</sup>
そこでプシケは、今度こそいよいよ自分の運もこれまでと覚悟し、あらゆる<ruby>表面<rp>(</rp><rt>うわべ</rt><rp>)</rp></ruby>のつくろいもかなぐりすてて、自分が無理やりにも最後のどたん場へと<ruby>急<rp>(</rp><rt>せ</rt><rp>)</rp></ruby>き立てられているのをはっきりと理解いたしました。
...
（それよりもあの）</p>
<p><sup>１８</sup>
アカイアの世にしられた町、<a href="#note_sparte" title="ラケダイモーン" id="sparte">ラケダイモーン</a>へはそう程遠くないのですから、その近処で<ruby>往<rp>(</rp><rt>おう</rt><rp>)</rp>還<rp>(</rp><rt>かん</rt><rp>)</rp></ruby>を離れた片田舎に、タイナロスというところを尋ねていらっしゃい。
...
憐れな死んでゆく人たちは是非とも路用を貰ってかないとならないので、もしひょっとして<ruby>懐<rp>(</rp><rt>ふとこ</rt><rp>)</rp></ruby>ろに銅銭がなかったら大変、もうそのままでは息を引き取らせて貰えません。</p>
<p>この薄汚い<ruby>爺<rp>(</rp><rt>じじ</rt><rp>)</rp></ruby>さんに<ruby>艀<rp>(</rp><rt>はしけ</rt><rp>)</rp>賃<rp>(</rp><rt>ちん</rt><rp>)</rp></ruby>として、持ってゆく二枚のお銭の片方をやるわけですが、それもカローンが自分の手であなたの口から<ruby>直接<rp>(</rp><rt>じか</rt><rp>)</rp></ruby>に取るようにおさせなさい。
そいからまたこの<ruby>緩<rp>(</rp><rt>ゆる</rt><rp>)</rp></ruby>やか流れを渡ってゆくときに、その川面に浮いてる年寄りの亡者が、<ruby>腐<rp>(</rp><rt>くさ</rt><rp>)</rp></ruby>れた手をさし出して船の中へ引き上げてくれと頼むでしょうが、あなたはけっして道に外れた憐れみに打ち負かされて（引き上げてやって）はいけません。</p>
<p><sup>１９</sup>
河を渡ってすこし行くと機織りの婆さんどもが布を織ってて、ちょっと手を貸してくれと頼みましょうが、しかしこれにも手を<ruby>触<rp>(</rp><rt>さ</rt><rp>)</rp></ruby>えるのは間違ったことです。
...
ただ何よりもとりわけて気をつけなければならないのは、けっしてどんなことがあっても手に持っているその<ruby>小<rp>(</rp><rt>こ</rt><rp>)</rp>筐<rp>(</rp><rt>ばこ</rt><rp>)</rp></ruby>を開けようとしたり、覗いて見たりしてはいけません、どうあろうともその中に<ruby>蔵<rp>(</rp><rt>かく</rt><rp>)</rp></ruby>されている神々しい美しさの<ruby>秘宝<rp>(</rp><rt>おたからもの</rt><rp>)</rp></ruby>を、物ずきになどと思ってはなりません。」</p>
<p><sup>２０</sup>
こうその智慧のひろい塔は<ruby>誇<rp>(</rp><rt>こま</rt><rp>)</rp>々<rp>(</rp><rt>ごま</rt><rp>)</rp></ruby>と親切に教え訓してくれました。
...
するとすぐさま小筐に何か容れて固く蓋をして渡してくれたので、それを持ってもう一つのお餅で<ruby>欺<rp>(</rp><rt>だま</rt><rp>)</rp></ruby>して吠える犬のロを封じ、残りのお<ruby>貨<rp>(</rp><rt>あし</rt><rp>)</rp></ruby>を船頭に払ってやって、<ruby>往<rp>(</rp><rt>ゆ</rt><rp>)</rp></ruby>きよりもずっと元気よくいそいそと<ruby>冥<rp>(</rp><rt>めい</rt><rp>)</rp>途<rp>(</rp><rt>ど</rt><rp>)</rp></ruby>から立ち戻ってまいりました。</p>
<p>このようにしてまたもとの<ruby>嚇<rp>(</rp><rt>あか</rt><rp>)</rp>々<rp>(</rp><rt>あか</rt><rp>)</rp></ruby>とした日の光を仰ぎ、手を合せて伏し拝んでみると、今までは早く<ruby>命<rp>(</rp><rt>いいつ</rt><rp>)</rp></ruby>けられた勤めを果そうとのみ思ってたものが、<ruby>遽<rp>(</rp><rt>にわ</rt><rp>)</rp></ruby>かに向う見ずな好奇心が胸に湧き立ってきて思うよう、<br />
「ちょっと、私もずいぶん<ruby>頓<rp>(</rp><rt>とん</rt><rp>)</rp>馬<rp>(</rp><rt>ま</rt><rp>)</rp></ruby>だわね、神々しい美しさを手に持ちながら、それをはんのちょっびりも自分ではお裾分けに預かれないなんて。
そうできもしたらあの立派ななつかしい方のお気にも入れようというのに。」</p>
<p><sup>２１</sup>
こう言うが早いか、<ruby>小<rp>(</rp><rt>こ</rt><rp>)</rp>賞<rp>(</rp><rt>ばこ</rt><rp>)</rp></ruby>をこじ開けて見ました。</p>
<p>ところがその中には美しさどころか、どんな物もはいっていず、ただ幽冥界の、というより<ruby>正<rp>(</rp><rt>しょう</rt><rp>)</rp>真<rp>(</rp><rt>しん</rt><rp>)</rp>正<rp>(</rp><rt>しょう</rt><rp>)</rp>銘<rp>(</rp><rt>めい</rt><rp>)</rp></ruby>の<ruby>地獄<rp>(</rp><rt>ステュクス</rt><rp>)</rp></ruby>の眠りだけが、蓋を取られると見る見る立ち昇ってプシケにかかり、<ruby>昏<rp>(</rp><rt>こん</rt><rp>)</rp>迷<rp>(</rp><rt>めい</rt><rp>)</rp></ruby>の<ruby>靄<rp>(</rp><rt>もや</rt><rp>)</rp></ruby>でひたひたと<ruby>手<rp>(</rp><rt>て</rt><rp>)</rp>肢<rp>(</rp><rt>あし</rt><rp>)</rp>中<rp>(</rp><rt>じゆう</rt><rp>)</rp></ruby>を取り巻いてしまいました。
プシケは立ち処にその場にくずおれて、じっと身動もせず横になった有様は、眼を<ruby>瞑<rp>(</rp><rt>つむ</rt><rp>)</rp></ruby>った<ruby>死<rp>(</rp><rt>し</rt><rp>)</rp>屍<rp>(</rp><rt>かばね</rt><rp>)</rp></ruby>と何の相違もありません。</p>
<p>さてクビードーはもう傷跡も固まり癒ってまいりましたので、長いこと大切なプシケと別れているのが我慢しきれなくなり、閉じ籠められてる寝部屋の上についた窓から脱け出すと、しばらくの休みに勢いをとり戻した翼に乗ってずんと進みも早く、プシケのところへ飛んで駈けつけました。
...
が、それには忘れずによくこれからは自分の競争者に気をつけるのだぞ、でもし今度地上でもって<ruby>容色<rp>(</rp><rt>みめかたち</rt><rp>)</rp></ruby>の並勝れて美しい<ruby>乙女<rp>(</rp><rt>おとめ</rt><rp>)</rp></ruby>を見つけたならば、この親切の返答には、ぜひその娘で礼をして貰わねばならんな。」</p>
<p><sup>２３</sup>
こうおっしゃるとメルクリウスに言いっけて神さま方をみんなすぐ会議にお寄せ集めになり、もしこの天上の集まりに欠席すれば百万<ruby>疋<rp>(</rp><rt>ひき</rt><rp>)</rp></ruby>の罰金をお取りになるよう<ruby>布<rp>(</rp><rt>ふ</rt><rp>)</rp>令<rp>(</rp><rt>れ</rt><rp>)</rp></ruby>させになりましたので、それが怖さに忽ち天上の<ruby>集合<rp>(</rp><rt>あつまり</rt><rp>)</rp>場<rp>(</rp><rt>ば</rt><rp>)</rp></ruby>は一杯になりました。
そこでユッピテルは高らかな御台座にいと高く座を占めさせて、こう<ruby>御<rp>(</rp><rt>み</rt><rp>)</rp>詔<rp>(</rp><rt>ことのり</rt><rp>)</rp></ruby>なさいました。</p>
<p>「わが神々たちよ、伎芸神女ムーサたちの（司る天上の）名簿にあるほどの方々、皆々がよく御存じのとおりここにいる若者は私の手で大きくなった者である。
...
「プシケ、さあ飲んで<ruby>常<rp>(</rp><rt>とこ</rt><rp>)</rp>磐<rp>(</rp><rt>わ</rt><rp>)</rp></ruby>の命を得よ、さすればもういつまでもそなたの手から<ruby>愛の神<rp>(</rp><rt>クビードー</rt><rp>)</rp></ruby>が傍へ外れることもなく、<ruby>未<rp>(</rp><rt>み</rt><rp>)</rp>来<rp>(</rp><rt>らい</rt><rp>)</rp>永<rp>(</rp><rt>えい</rt><rp>)</rp>劫<rp>(</rp><rt>ごう</rt><rp>)</rp></ruby>この縁の絶えることもあるまいから。」</p>
<p><sup>２４</sup>
...
ギリシャ神話では、古代ギリシャ語で、「<ruby>Psykhé<rp>(</rp><rt>Ψυχή</rt><rp>)</rp></ruby>」（発音：プシューケー）があって、心魂、精神、心霊の義をしめしています。<br />
...
<div class="notices blue">
<p><a href="#apollo" title="ミレトスにおいでの神様" id="note_apollo"><ruby lang="ja">ミレトス<rp>(</rp><rt lang="grc">Μίλητος</rt><rp>)</rp></ruby lang="ja">においでの神様</a>はミレトス市の郊外<ruby>ディディマ<rp>(</rp><rt>Didyma</rt><rp>)</rp></ruby>にあるアポロンの有名な社があったため、太陽の神の意が示されている。<a href="#apollo" title="ミレトスにおいでの神様">戻る ↑</a></p>
</div>
<div class="notices blue">
...
<div class="notices blue">
<p><a href="https://ja.wikipedia.org/wiki/ヘーラー" title="https://ja.wikipedia.org/wiki/ヘーラー" id="note_echo">山ずみの女神</a> <a href="https://ja.wikipedia.org/wiki/エーコー" title="https://ja.wikipedia.org/wiki/エーコー"><ruby>エコー<rp>(</rp><rt>Ἠχώ</rt><rp>)</rp></ruby></a>のことで、森のニンフ。<a href="https://ja.wikipedia.org/wiki/パーン_(ギリシア神話)" title="https://ja.wikipedia.org/wiki/パーン_(ギリシア神話)"><ruby>パーン<rp>(</rp><rt>Πάν</rt><rp>)</rp></ruby></a>を恐れて逃げ、姿のない声と化して、<ruby>谺<rp>(</rp><rt>こだま</rt><rp>)</rp></ruby>の意を示している呼称となりました。<a href="#echo" title="山ずみの女神">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#mars" title="義理のお父様でも" id="note_mars">義理のお父様でも</a> 軍の神、<a href="https://ja.wikipedia.org/wiki/マールス" title="https://ja.wikipedia.org/wiki/マールス"><ruby>マルス<rp>(</rp><rt>Mars</rt><rp>)</rp></ruby></a>のこと。<ruby>愛の神<rp>(</rp><rt>クピードー</rt><rp>)</rp></ruby>の父は明らかでなく<a href="https://ja.wikipedia.org/wiki/ユーピテル" title="https://ja.wikipedia.org/wiki/ユーピテル"><ruby>ユッピテル<rp>(</rp><rt>Jupiter</rt><rp>)</rp></ruby></a>ともいう。<a href="#mars" title="義理のお父様でも">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#ceres" title="ケレースとユーノーの二方の女神" id="note_ceres"><ruby>ケレース<rp>(</rp><rt>Ceres</rt><rp>)</rp></ruby>と<ruby>ユーノー<rp>(</rp><rt>Juno</rt><rp>)</rp></ruby>の二方の女神</a> <a href="https://ja.wikipedia.org/wiki/ケレース" title="https://ja.wikipedia.org/wiki/ケレース"><ruby>ケレース<rp>(</rp><rt>Ceres</rt><rp>)</rp></ruby></a>はギリシャの<a href="https://ja.wikipedia.org/wiki/デーメーテール" title="https://ja.wikipedia.org/wiki/デーメーテール"><ruby>デメテル<rp>(</rp><rt>Δημήτηρ</rt><rp>)</rp></ruby></a>で大地豊穣の女神。<a href="https://ja.wikipedia.org/wiki/ユーノー" title="https://ja.wikipedia.org/wiki/ユーノー"><ruby>ユーノー<rp>(</rp><rt>Juno</rt><rp>)</rp></ruby></a>は<a href="https://ja.wikipedia.org/wiki/ヘーラー" title="https://ja.wikipedia.org/wiki/ヘーラー"><ruby>ヘラ<rp>(</rp><rt>Ἥρα</rt><rp>)</rp></ruby></a>で、<a href="https://ja.wikipedia.org/wiki/ユーピテル" title="https://ja.wikipedia.org/wiki/ユーピテル"><ruby>ユッピテル<rp>(</rp><rt>Jupiter</rt><rp>)</rp></ruby></a>の妃。<a href="#note_ceres" title="ケレースとユーノーの二方の女神">戻る ↑</a></p>
</div><div class="notices blue">
<p><a href="#eleusis" title="エレウシスの聖い籠" id="note_eleusis">エレウシスの聖い籠</a>　<a href="https://ja.wikipedia.org/wiki/アッティカ" title="https://ja.wikipedia.org/wiki/アッティカ"><ruby>アッティカ<rp>(</rp><rt>Ἀττική</rt><rp>)</rp></ruby></a>の<a href="https://ja.wikipedia.org/wiki/エレウシス" title="https://ja.wikipedia.org/wiki/エレウシス"><ruby>エレウシス<rp>(</rp><rt>Ἐλευσίς</rt><rp>)</rp></ruby></a>は、<a href="https://ja.wikipedia.org/wiki/デーメーテール" title="https://ja.wikipedia.org/wiki/デーメーテール">デメテル</a>崇拝の本拠地。それには様々な秘儀が行われ、ここにいう編細工のは籠筒は聖食を容れるためのもの。<a href="#eleusis" title="エレウシスの聖い籠">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#cartage" title="高いカルタゴ" id="note_cartage">高いカルタゴ</a> <a href="https://ja.wikipedia.org/wiki/ネイト_(エジプト神話)#.E7.BF.92.E5.90.88.E9.96.A2.E4.BF.82" title="https://ja.wikipedia.org/wiki/ネイト_(エジプト神話)#.E7.BF.92.E5.90.88.E9.96.A2.E4.BF.82"><ruby>カルターゴ―<rp>(</rp><rt>Carthāgō</rt><rp>)</rp></ruby>の女神<ruby>タニト<rp>(</rp><rt>Tanit</rt><rp>)</rp></ruby></a>のこと。著者アプレイウスの出身である北アフリカの文化でエジプト神話から信仰されていた女神。ユーノーの権化と解され、「天上のユーノー」とも称せられた。<a href="#cartage" title="高いカルタゴ">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="https://ja.wikipedia.org/wiki/メルクリウス" title="https://ja.wikipedia.org/wiki/メルクリウス" id="note_mercurius"><ruby>メルクリウス<rp>(</rp><rt>Mercurius</rt><rp>)</rp></ruby></a> <a href="https://ja.wikipedia.org/wiki/ヘルメース" title="https://ja.wikipedia.org/wiki/ヘルメース">即ち、ギリシャの<ruby>ヘルメス<rp>(</rp><rt>Ἑρμῆς</rt><rp>)</rp></ruby></a>で伝令通商の神。<a href="https://ja.wikipedia.org/wiki/アルカディア" title="https://ja.wikipedia.org/wiki/アルカディア"><ruby>アルカディア<rp>(</rp><rt>Ἀρκαδία</rt><rp>)</rp></ruby></a>の山中に生まれた。<a href="#mercurius" title="メルクリウス">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#murcia" title="ムルキアの円柱" id="note_murcia">ムルキアの円柱</a> ローマの<a href="https://ja.wikipedia.org/wiki/チルコ・マッシモ" title="https://ja.wikipedia.org/wiki/チルコ・マッシモ"><ruby>キルクス<rp>(</rp><rt>Circus</rt><rp>)</rp>・<rp>(</rp><rt></rt><rp>)</rp>マクシムス<rp>(</rp><rt>Maximus</rt><rp>)</rp></ruby></a>の南にある女神<ruby>ムルキア<rp>(</rp><rt>Murcia</rt><rp>)</rp></ruby>の社で、また<a href="https://ja.wikipedia.org/wiki/ヴェヌス#.E6.B7.BB.E3.81.88.E5.90.8D" title="https://ja.wikipedia.org/wiki/ヴェヌス#.E6.B7.BB.E3.81.88.E5.90.8D">ムルキアのヴェヌス</a>の名で、ヴェヌスの権化とも考えられた。<a href="#murcia" title="ムルキアの円柱">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#aurora" title="払暁がほんのいま馬車" id="note_aurora"><ruby>払暁<rp>(</rp><rt>あけがた</rt><rp>)</rp></ruby>がほんのいま<ruby>馬車<rp>(</rp><rt>くるま</rt><rp>)</rp></ruby></a>　<ruby>暁<rp>(</rp><rt>あかつき</rt><rp>)</rp></ruby>の女神<a href="https://ja.wikipedia.org/wiki/アウローラ" title="https://ja.wikipedia.org/wiki/アウローラ"><ruby>アウローラ<rp>(</rp><rt>Aurōra</rt><rp>)</rp></ruby></a>、天馬の車に乗る姿で<ruby>屡<rp>(</rp><rt>しば</rt><rp>)</rp>々<rp>(</rp><rt>しば</rt><rp>)</rp></ruby>表わされる。<a href="#aurora" title="払暁がほんのいま馬車">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#ganymede" title="払暁がほんのいま馬車" id="note_ganymede">ブリュギアの少年</a> <a href="https://ja.wikipedia.org/wiki/イリオス" title="https://ja.wikipedia.org/wiki/イリオス"><ruby>トロイア<rp>(</rp><rt>Τροία</rt><rp>)</rp></ruby></a>の王子<a href="https://ja.wikipedia.org/wiki/ガニュメーデース" title="https://ja.wikipedia.org/wiki/ガニュメーデース"><ruby>ガニュメーデース<rp>(</rp><rt>Γανυμήδης</rt><rp>)</rp></ruby></a>のこと。<br />
<ruby>ユッピテル<rp>(</rp><rt>Jupiter</rt><rp>)</rp></ruby>が鷲と化して、天上に<ruby>拉<rp>(</rp><rt>ら</rt><rp>)</rp>致<rp>(</rp><rt>ち</rt><rp>)</rp></ruby>して、その酒注ぎ役の少年とされた。<a href="#ganymede" title="払暁がほんのいま馬車">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#sparte" title="ラケダイモーン" id="note_sparte">ラケダイモーン</a> <a href="https://ja.wikipedia.org/wiki/スパルタ" title="https://ja.wikipedia.org/wiki/スパルタ"><ruby>スパルタ<rp>(</rp><rt>Σπάρτα</rt><rp>)</rp></ruby></a>のこと。<a href="https://ja.wikipedia.org/wiki/マタパン岬" title="https://ja.wikipedia.org/wiki/マタパン岬"><ruby>タイナロン<rp>(</rp><rt>Ταίναρον</rt><rp>)</rp></ruby></a>岬に洞穴があり、冥界へ通ずると古より伝えられたこと、<a href="https://ja.wikipedia.org/wiki/ヴェルギリウス" title="https://ja.wikipedia.org/wiki/ヴェルギリウス"><ruby>ヴェルギリウス<rp>(</rp><rt>Virgilius</rt><rp>)</rp></ruby></a>、<a href="https://ja.wikipedia.org/wiki/ホラティウス" title="https://ja.wikipedia.org/wiki/ホラティウス"><ruby>ホラティウス<rp>(</rp><rt>Horatius</rt><rp>)</rp></ruby></a>にも出ている。<a href="#sparte" title="ラケダイモーン">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#charon" title="カローン" id="note_charon"><ruby>カローン<rp>(</rp><rt>Χάρων</rt><rp>)</rp></ruby></a> <a href="https://ja.wikipedia.org/wiki/カローン" title="https://ja.wikipedia.org/wiki/カローン">詳しくは ↑</a> は三途の河<a href="https://ja.wikipedia.org/wiki/アケローオス" title="https://ja.wikipedia.org/wiki/アケローオス"><ruby>アケロオス<rp>(</rp><rt>Ἀχέλῷος</rt><rp>)</rp></ruby></a>の渡守。なお三首の犬とは<a href="https://ja.wikipedia.org/wiki/ケルベロス" title="https://ja.wikipedia.org/wiki/ケルベロス"><ruby>ケルベルス<rp>(</rp><rt>Cerberus</rt><rp>)</rp></ruby></a>のこと。<a href="#charon" title="カローン">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#proserpine" title="プロセルビナ" id="note_proserpine"><ruby>プロセルビナ<rp>(</rp><rt>Proserpina</rt><rp>)</rp></ruby></a>はギリシャの<a href="https://ja.wikipedia.org/wiki/ペルセポネー" title="https://ja.wikipedia.org/wiki/ペルセポネー"><ruby>ペルセフォーネ―<rp>(</rp><rt>Περσεφόνη</rt><rp>)</rp></ruby></a>。<br />
<a href="https://ja.wikipedia.org/wiki/ケレース" title="https://ja.wikipedia.org/wiki/ケレース"><ruby>ケレス<rp>(</rp><rt>Ceres</rt><rp>)</rp></ruby></a>の娘、ここでは、「<ruby>ディース<rp>(</rp><rt>Dis</rt><rp>)</rp></ruby>」と呼ばれている冥界の王の<a href="https://ja.wikipedia.org/wiki/プルートス" title="https://ja.wikipedia.org/wiki/プルートス"><ruby>プルトス<rp>(</rp><rt>Πλοῦτος</rt><rp>)</rp></ruby></a>の后。<a href="#proserpine" title="プロセルビナ">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#liber" title="酒神" id="note_liber"><ruby>酒神<rp>(</rp><rt>リーベル</rt><rp>)</rp></ruby></a>はローマの<a href="https://ja.wikipedia.org/wiki/バックス_(ローマ神話)" title="https://ja.wikipedia.org/wiki/バックス_(ローマ神話)"><ruby>バックス<rp>(</rp><rt>Bacchus</rt><rp>)</rp></ruby></a>の異名で、ギリシャ神話の<a href="https://ja.wikipedia.org/wiki/ディオニューソス" title="https://ja.wikipedia.org/wiki/ディオニューソス"><ruby>ディオニューソス<rp>(</rp><rt>Διόνυσος</rt><rp>)</rp></ruby></a>のラテン名、<a href="https://ja.wikipedia.org/wiki/ウゥルカーヌス" title="https://ja.wikipedia.org/wiki/ウゥルカーヌス"><ruby>ヴルカーヌス<rp>(</rp><rt>Vulcānus</rt><rp>)</rp></ruby></a>は火と鍛治の神だから料理にしたものだろう。<a href="#liber" title="酒神">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#hora" title="季節神女ホラたち" id="note_hora">季節神女<ruby>ホラ<rp>(</rp><rt>Hora</rt><rp>)</rp></ruby>たち</a>は、次級の女神。<a href="https://francois-vidit.com/docs/ja/versailles/trianon/flore#note_hora" title="https://francois-vidit.com/docs/ja/versailles/trianon/flore#note_hora">詳しくは</a> <a href="#hora" title="季節神女ホラたち">戻る ↑</a></p>
</div>
<div class="notices blue">
<p><a href="#gratia" title="優美神女グラティアたち" id="note_gratia">優美神女<ruby>グラティア<rp>(</rp><rt>Gratia</rt><rp>)</rp></ruby>たち</a>は、ギリシャ名で「<a href="https://francois-vidit.com/docs/ja/versailles/trianon/flore#note_charis" title="https://francois-vidit.com/docs/ja/versailles/trianon/flore#note_charis">女神<ruby>カリス<rp>(</rp><rt>Charis</rt><rp>)</rp></ruby>たち</a>」で、次級の女神。<a href="#gratia" title="優美神女グラティアたち">戻る ↑</a></p>
</div>
`;
