...
<li>こんな次第で<ruby>不<rp>(</rp><rt>ふ</rt><rp>)</rp>幸<rp>(</rp><rt>しあわせ</rt><rp>)</rp></ruby>な姫の父王も大変お困りになり、もしや天上の神々のお憎しみからか、または神怒の<ruby>所為<rp>(</rp><rt>せい</rt><rp>)</rp></ruby>でもと畏れ気遣い、<a href="#note_apollo" title="パライモーン" id="apollo"><ruby lang="ja">ミレトス<rp>(</rp><rt lang="grc">Μίλητος</rt><rp>)</rp></ruby>においでの神様</a>の大昔から伝わた御<ruby>託<rp>(</rp><rt>たく</rt><rp>)</rp>宣<rp>(</rp><rt>せん</rt><rp>)</rp></ruby>を伺うことにし、<ruby>祈<rp>(</rp><rt>き</rt><rp>)</rp>禱<rp>(</rp><rt>とう</rt><rp>)</rp></ruby>をしたり供物を捧げたりして、大神さまにこの求め手もない<ruby>少女<rp>(</rp><rt>おとめ</rt><rp>)</rp></ruby>に縁組と良人とを授けて下さいますよう、お願い致しました。
...
<div class="notices blue">
<p><a href="#palaimon" title="パライモーン"><ruby lang="ja">パライモーン<rp>(</rp><rt lang="grc">Παλαίμων</rt><rp>)</rp></ruby></a>ギリシャ伝説にある童形の海の神。</p>
</div>
