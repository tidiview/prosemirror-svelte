...
<p><time datetime="2020-03-12">12 Mar. 2020</time></p>

<h1 class="yellow"><a href="/blog/fr/phedre">Phèdre</a></h1>

<div class="notices yellow">
<p>Dans cette partie du dialogue Phèdre (246a–248c), Platon décrit la nature de l'âme, comme une puissance composée par un attelage ailé céleste qui quitte sa demeure afin de participer à la marche céleste.</p>
...
<li id="246A">Aussi bien, <span style="color:#df8a13;">sur l'immortalité –de l'âme–</span>, voilà qui suffit. Pour ce qui est de sa forme, voici ce qu'il faut dire.</li>
...
<li id="246B">Cela étant, <span style="color:#df8a13;">chez les dieux, les chevaux et les cochers sont tous bons et de bonne race</span>, alors que, <span style="color:#df8a13;">pour le reste des vivants, il y a mélange</span>.</li>
...
<li id="246C">Tout ce qui est <span style="color:#df8a13;">âme</span> a charge de tout ce qui est inanimé;</li>
...
<li id="246D">c'est un vivant immortel, qui a une <span style="color:#df8a13;">âme</span>, qui a un <span style="color:#13aadd;">corps</span>, tous deux naturellement unis pour toujours.</li>
...
<li id="246E">Or, le divin est beau, sage, bon et possède toutes les qualités de cet ordre:</li>
...
<li id="247A">car Hestia reste dans la demeure des dieux, toute seule.</li>
...
<li id="247B">Or, chaque fois qu'ils se rendent à un festin, c'est-à-dire à un banquet,</li>
...
<li id="247C">En effet, lorsqu'elles ont atteint la voûte du ciel, ces <span style="color:#df8a13;">âmes</span> qu'on dit immortelles passent à l'extérieur,</li>
...
<li id="247E">nous qualifions de réelles, mais celle qui s'applique à ce qui est réellement la réalité.</li>
...
<li id="248A">«Voilà quelle est la vie des dieux.</li>
...
<li id="248B">elles se piétinent, se bousculent, chacune essayant de devancer l'autre.</li>
...
<li id="248C">Parce que la nourriture qui convient à ce qu'il y a de meilleur dans l'<span style="color:#df8a13;">âme</span> se tire de la prairie qui s'y trouve, et que l'<span style="color:#a4660e;">aile</span>, à quoi l'<span style="color:#df8a13;">âme</span> doit sa légèreté, y prend ce qui la nourrit.</li>
</ol>
</article>
`;
