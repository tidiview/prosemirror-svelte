...
<p>Dans “le Banquet” de Platon, quelques personnes assemblées à l'occasion d'une fête mondaine, échangent leurs vues sur le sens de l'<ruby lang="fr">amour<rp>(</rp><rt lang="grc">Érôs</rt><rp>)</rp></ruby>.</p>
...
<ol class="doc-three-rows">
  <li data-name="【SOCRATE】">— Quel est son père, repris-je, et quelle est sa mère?</li>
  <li data-id="203b" data-name="【DIOTIME】">— C'est une assez longue histoire, répondit-elle. Je vais pourtant te la raconter.</li>
  ...
  <li data-id="203c">Alors Pénia, dans sa pénurie, eut le projet de se faire faire un enfant par Poros; elle s'étendit près de lui et devint grosse d'Eros.</li>
  ...
  <li data-id="203e">Il faut ajouter que par nature il n'est ni immortel ni mortel.</li>
  ...
  <li data-id="204a" data-name="【DIOTIME】">— Voici en effet ce qu'il en est.</li>
  ...
  <li data-name="【SOCRATE】">— Qui donc, Diotime, demandai-je, sont ceux qui tendent vers le savoir, si ce ne sont ni les savants ni les ignorants?</li>
  <li data-name="【DIOTIME】">— D'ores et déjà, répondit-elle, il est parfaitement clair, même pour un enfant, que ce sont ceux qui se trouvent entre les deux, et qu'Éros doit être du nombre.</li>
...
<footer>
  ...
  <p><time datetime="PT2M">2&nbsp;min</time>.</p>
</footer>
...
<section id="note_socrate">
<h4 class="blue note">Socrate</h4>
...
<footer>
  <p class="puce"><a href="/blog/fr/eros#socrate" title="Socrate">retour au texte&nbsp;↩</a></p>
</footer>
</section>

<section id="note_diotime">
<h4 class="blue note">Diotime</h4>
...
<footer>
  <p class="puce"><a href="/blog/fr/eros#diotime" title="Diotime">retour au texte&nbsp;↩</a></p>
</footer>
</section>

<section id="note_poros">
<h4 class="blue note">Poros</h4>

<div class="notices blue">
<p><i><ruby lang="fr">Poros<rp>(</rp><rt lang="grc">Πόρος</rt><rp>)</rp></ruby></i>, en grec, signifie «passage», d'où «ressource», «expédient».</p>
</div>
<footer>
  <p class="puce"><a href="/blog/fr/eros#poros" title="Poros">retour au texte&nbsp;↩</a></p>
</footer>
</section>

<section id="note_penia">
<h4 class="blue note">Penia</h4>

<div class="notices blue">
<p><i><ruby lang="fr">Penia<rp>(</rp><rt lang="grc">Πενία</rt><rp>)</rp></ruby></i>, c'est-à-dire, en grec, la Pauvreté.</p>
</div>
<footer>
  <p class="puce"><a href="/blog/fr/eros#penia" title="Pénia">retour au texte&nbsp;↩</a></p>
</footer>
</section>

<section id="note_nectar">
<h4 class="blue note">nectar</h4>

<div class="notices blue">
<p>Le <i>nectar</i> est la boisson des dieux, source de leur immortalité. retour à la note ↑</p>
</div>
<footer>
  <p class="puce"><a href="/blog/fr/eros#nectar" title="nectar">retour au texte&nbsp;↩</a></p>
</footer>
</section>

<section id="note_philosopher">
<h4 class="blue note">philosopher</h4>

<div class="notices blue">
<p><i>Philosopher</i>, c'est-à-dire aussi littéralement à «aimer la sagesse». </p>
</div>
<footer>
  <p class="puce"><a href="/blog/fr/eros#philosopher" title="Philosopher">retour au texte&nbsp;↩</a></p>
</footer>
</section>
