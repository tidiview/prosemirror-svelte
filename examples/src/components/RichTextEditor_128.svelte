...
神たるふたりのお子を、しかとその胸に抱いていたとのことです。</p>
<p>さて、怪物キマイラの故郷であるリュキアヘたどりついた女神でしたが、おりしも、堪えがたい日さしが田野を焼いています。</p>
<p><sup>３４０</sup>
長い幸労に疲れはてた女神は照りつける熱さに、<ruby>喉<rp>(</rp><rt>のど</rt><rp>)</rp></ruby>の喝きを訴えました。
両の乳房も、むさぼり飲む子供たちに吸いつくされた。</p>
<p>と、たまたま、谷底に、ほどよい大きさの潮が見えました。
...
そんな百姓たちに、女神はこういいました。</p>
<p>「どうして、わたしに水を飲ませないのですか。
