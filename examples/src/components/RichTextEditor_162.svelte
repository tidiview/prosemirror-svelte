...
<p>Sa vie durant, elle n'a en effet eu de cesse de lui disputer l'excellence de cet art, ainsi que le raconte <a href="https://fr.wikipedia.org/wiki/Ovide" title="https://fr.wikipedia.org/wiki/Ovide">Ovide</a> dans le livre VI des <a href="https://fr.wikipedia.org/wiki/Métamorphoses_(Ovide)" title="https://fr.wikipedia.org/wiki/Métamorphoses_(Ovide)"><cite>Métamorphoses</cite></a>.</p>
<p>En voici le texte ci-dessous.</p>
</div>

<h2 id="arachnee" class="red">Arachnée selon le texte du livre VI des <cite>Métamorphoses</cite></h2>
...
<footer>
  <p><span style="color: #b52b27;">Ovide, <cite>les Métamorphoses</cite>, Livre VI, vers 1 à 148.</span></p>
</footer>
