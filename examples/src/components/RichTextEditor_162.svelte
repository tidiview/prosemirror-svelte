...
<sup>1</sup>
Tritonia avait prêté l'oreille à ces récits des Aonides,<br>
...
Et ne tolérerai pas que l'on bafoue ma divine puissance impunément.»<br>
<sup>5 </sup>
lle décide de perdre Arachné la Méonienne<br>
...
Teignait la laine en la trempant dans la pourpre de Phocée ;<br>
<sup>10</sup>
Elle a perdu sa mère qui, comme son mari,<br>
...
Pour voir ses ouvrages admirables, souvent<br>
<sup>15</sup>
Les nymphes du Tmolus ont délaissé leurs vignes,<br>
...
La voir mettre en pelote la laine non encore travaillée,<br>
<sup>20</sup>
La voir du doigt lisser son ouvrage et tirer longuement sur les flocons<br>
...
Or, elle nie cela et, refusant l'idée d'une enseignante aussi illustre,<br>
<sup>25</sup>
Elle a dit: «Qu'elle se mesure à moi; si je perds, je me soumettrai.»<br>
...
Puis, elle s'adresse à elle en ces termes: «Le grand âge n'a pas<br>
Que des côtés désagréables; la vieillesse apporte l'expérience.<br>
<sup>30</sup>
Ne rejette pas mes conseils: tu peux vouloir la réputation<br>
D'être, parmi les mortelles, celle qui tisse le mieux la laine ;<br>
Mais cède devant une déesse, étourdie, et demande pardon,<br>
D'une voix suppliante, pour tes propos; si tu la prie, elle pardonnera.»<br>
La regardant de travers, Arachné laisse le tissu commencé<br>
<sup>35</sup>
Et, retenant sa main avec peine, le visage marqué par la colère,<br>
C'est ainsi qu'elle répond à Pallas méconnaissable :<br>
« Tu n'as plus ta tête; ta vieillesse prolongée t'a profondément amoindrie ;<br>
Il n'est pas bon de vivre trop longtemps. Si tu as une bru,<br>
Si tu as une fille, qu'elles écoutent de tels discours.<br>
<sup>40</sup>
Je n'ai que faire de tes conseils; ne crois pas que tes objurations<br>
Me soient de quelque utilité: je ne changerai pas d'avis.<br>
Pourquoi ne vient-elle pas? Pourquoi évite-t-elle l'affrontement ?<br>
Alors la déesse dit: «La voici», et elle se défait de son aspect<br>
De vieille, et Pallas apparaît. Nymphes et Mygdoniennes<br>
<sup>45</sup>
Révèrent sa puissance: seule, la jeune fille n'a pas peur.<br>
...
Et, au lever du soleil, redevient très rapidement blanc.<br>
<sup>50</sup>
Elle s'obstine dons son projet et ce désir stupidede remporter<br>
...
Deux métiers à tisser et y tendent les minces fils de la chaîne;<br>
<sup>55</sup>
Une traverse en relie les montants, un roseau en sépare les fils,<br>
...
Elles se hâtent toutes deux et, manches retroussées jusqu'au buste,<br>
<sup>60</sup>
Leurs bras s'activent avec habileté et une ardeur qui trompe la fatigue.<br>
...
Frappe les rayons du soleil, s'étire dans tout le ciel :<br>
<sup>65</sup>
Bien que mille couleurs chatoyantes y scintillent,<br>
...
Et vient broder sur le tissu des scènes d'autrefois.<br>
<sup>70</sup>
Pallas dépeint le rocher de Mars, sur les hauteurs d'Athènes,<br>
...
Avec ses attributs distinctifs: le portrait de Jupiter est d'un roi.<br>
<sup>75</sup>
Le dieu des eaux est montré debout, frappant d'âpres rochers<br>
...
Pose un casque sur sa tête, protège sa poitrine par une égide<br>
<sup>80</sup>
Et dessine la terre, frappée de sa lance,<br>
...
Quelle récompense elle peut attendre d'une si folle audace,<br>
<sup>85</sup>
Elle ajoute aux quatre coins quatre défis lancés,<br>
...
Qui usurpèrent les noms des plus grands dieux.<br>
<sup>90</sup>
Un autre retrace la mère des Pygmées le destin pathétique :<br>
...
À l'épouse de Jupiter le Grand, et que la royale Junon<br>
<sup>95</sup>
Transforma en oiseau: ni Ilion ni son père Laomédon<br>
...
On peut le voir embrasser les marches du temple,<br>
<sup>100</sup>
À savoir les corps de ses filles, et, allongé sur la pierre, pleurer.<br>
...
De taureau; on croirait voir un vrai taureau, une vraie mer.<br>
<sup>105</sup>
La jeune fille semble regarder la terre qu'elle laisse,<br>
...
Qui la domine, Léda étendue sous les ailes d'un cygne ;<br>
<sup>110</sup>
Elle y ajoute Jupiter caché sous l'aspect d'un satyre<br>
...
Berger pour Mnémosyne, serpent moucheté pour la fille de Déo.<br>
<sup>115</sup>
Elle te montre aussi, Neptune, changé en farouche taureau<br>
...
Celle aux cheveux dorés; oiseau, celle à la chevelure de serpents,<br>
<sup>120</sup>La mère du cheval ailé; dauphin, tu fis jouir Mélantho.<br>
...
Puis Liber déguisé en grappe de raisin pour abuser Érigoné,<br>
<sup>125</sup>Puis Saturne en cheval pour engendrer Chiron au corps double.<br>
...
Déchire le tissu coloré et ses adultères divins<br>
<sup>130</sup>
Et, tenant à la main sa navette du mont Cytore,<br>
...
En disant: «Vis donc, mais reste pendue, impudente,<br>
<sup>140</sup>
Et que ce châtiment s'exerce - pour que ton avenir soit sans espoir -<br>
Sur toute ta race jusqu'à tes plus loins descendants.»<br>
...
Ses cheveux tombent et avec eux, son nez et ses oreilles,<br>
<sup>145</sup>
Sa tête se rapetisse, son corps tout entier se réduit ;<br>
Des pattes grêles se fixent sur les côtés en guise de jambes,<br>
Elle n'a plus qu'un ventre: mais elle continue à produire du fil<br>
<sup>149</sup>
...
<p><span style="color: #b52b27;">Ovide, “les Métamorphoses”, Livre 6</span>  </p>
</div>
`;
