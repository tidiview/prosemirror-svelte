...
export const ExtendedThreerichTextSchema = new Schema({
  nodes: {
    ...
    paragraph: {
      ...
      parseDOM: [{tag: "p.conversation", getAttrs(dom) { return {classe: dom.getAttribute("class"), color: dom.style["color"], flag: true, id: dom.id} }},{tag: "p.puce", getAttrs(dom) { return {classe: dom.getAttribute("class"), color: dom.style["color"], flag: true} }},{tag: "p", getAttrs(dom) { return {color: dom.style["color"]} }},{tag: "dl dt"},{tag: "dd"}],
